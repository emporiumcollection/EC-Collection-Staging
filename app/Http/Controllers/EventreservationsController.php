...
use App\Models\Eventreservations;
...
class EventreservationsController extends Controller {
	...
	public $module = 'eventreservations';
	static $per_page	= '10';
	...
	public function __construct()
	{
		...
		$this->model = new Eventreservations();
	...
	public function getIndex( Request $request )
	{
		...
		$pagination->setPath('eventreservations');
	...
	function getUpdate(Request $request, $id = null)
	{
		...
		if($row)
		{
			...
			$this->data['row'] = $this->model->getColumnTable('tb_event_reservations'); 
		}
	...
	function postSave( Request $request)
	{
		...
		if ($validator->passes()) {
			$data = $this->validatePost('tb_eventreservations');
				
			$id = $this->model->insertRow($data , $request->input('id'));
			
			if(!is_null($request->input('apply')))
			{
				$return = 'eventreservations/update/'.$id.'?return='.self::returnUrl();
			} else {
				$return = 'eventreservations?return='.self::returnUrl();
			}
			...
			return Redirect::to('eventreservations/update/'.$id)->with('messagetext',\Lang::get('core.note_error'))->with('msgstatus','error')
	...
	public function postDelete( Request $request)
	{
		...
		if(count($request->input('ids')) >=1)
		{
			...
			// redirect
			return Redirect::to('eventreservations')
