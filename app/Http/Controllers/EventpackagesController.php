...
class EventpackagesController extends Controller {
	...
	public function getIndex( Request $request )
	{
		...
		$pagination->setPath('eventpackages');
	...
	function getUpdate(Request $request, $id = null)
	{
		...
		if($row)
		{
			...
			$this->data['row'] = $this->model->getColumnTable('tb_event_packages'); 
		}
	...
	function postSave( Request $request)
	{
		...
		if ($validator->passes()) {
			...
			{
				$return = 'eventpackages/update/'.$id.'?return='.self::returnUrl();
			} else {
				$return = 'eventpackages?return='.self::returnUrl();
			}
			...
			return Redirect::to('eventpackages/update/'.$id)->with('messagetext',\Lang::get('core.note_error'))->with('msgstatus','error')
	...
	public function postDelete( Request $request)
	{
		...
		if(count($request->input('ids')) >=1)
		{
			...
			// redirect
			return Redirect::to('eventpackages')
