...
class FrontendPagesController extends Controller {
	...
	public function socialYoutube(Request $request)
	{
		...
		{
			$cateObjsc = \DB::table('tb_categories')->select('category_youtube_channel_url')->where('parent_category_id', 0)->where('category_published', 1)->where('id', '!=', 8)->orderBy('category_order_num','asc')->first();
		}
