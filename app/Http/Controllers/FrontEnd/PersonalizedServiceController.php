...
class PersonalizedServiceController extends Controller {
    ...
    */
    public function index(Request $request) {
        ...
        $this->data['accommodations'] = \DB::table('tb_categories')->select('id', 'parent_category_id', 'category_name', 'category_image', 'category_custom_title')->where('category_published', 1)->where('parent_category_id', 8)->get();
