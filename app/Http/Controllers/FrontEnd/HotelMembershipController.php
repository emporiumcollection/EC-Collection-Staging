...
class HotelMembershipController extends Controller {
    ...
    public function __construct() {
        ...
        $this->data['pageslider'] = \DB::table('tb_pages_sliders')->select( 'slider_title', 'slider_description', 'slider_img', 'slider_link', 'slider_video', 'slide_type')->where('slider_page_id', 2)->get();
