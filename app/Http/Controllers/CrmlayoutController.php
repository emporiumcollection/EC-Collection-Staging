...
class CrmlayoutController extends Controller {
    ...
    public function create() {
        ...
        $this->data['modules'] = Module::select('module_id','module_title')->whereIn('module_name', array('qualityassurance', 'crmhotel', 'users','groups','bookings','module','invoices','employee'))->get();
            ...
            foreach ($all_rows as $r_key => $all_row) {
                ...
                if(!empty($all_other_groups)) {
                    foreach ($all_other_groups as $key => $all_other_group) {
                        ...
                        $custom_fields = Module::join('ai_crm_groups','ai_crm_groups.idmod_mfg','=','tb_module.module_id')
