...
<div class="wrap settings_wrap">
	...
	<div class="rs_breadcrumbs">
        <div class="rs-breadcrumbs-wrapper">
            ...
            <a class='breadcrumb-button selected' href="#" id="rs_breadcrumbs_slider_settings" data-id="<?php echo $sliderID; ?>" ><i class="eg-icon-cog"></i><?php _e('Slider Settings', 'revslider');?></a>
	...
	<div class="settings_panel">
        <div class="settings_panel_left settings_wrapper<?php echo $settings_wrapper_class;?>">
                ...
                <div id="slider_title_sb" class="setting_box" style="background:#fff">
					...
					<div class="inside">
						<div class="slidertitlebox">
							...
							<span class="one-third-container" style="display:none;">
            ...
            if ($is_edit) {
                ...
                $custom_js = '';
                if (!empty($sliderID)) {
                    $custom_css = isset($arrFieldsParams['custom_css']) ? stripslashes($arrFieldsParams['custom_css']) : '';
                    $custom_js = isset($arrFieldsParams['custom_javascript']) ? stripslashes($arrFieldsParams['custom_javascript']) : '';
                }
...
<div class="rs-dialog-embed-slider" style="display: none;">
	...
	<div style="margin:5px 0px; padding-left: 55px;">
		...
		<code><?php echo htmlentities("<?php RevSliderEmbedder::putRevSlider('"); ?><span class="rs-example-alias"><?php echo $exampleID; ?></span><?php echo htmlentities("'); ?>"); ?></code>
	</div>
</div>
