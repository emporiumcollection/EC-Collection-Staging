...
<div class="wrap settings_wrap">
	...
	<div class="rs_breadcrumbs">
        ...
        <a class='breadcrumb-button' href="<?php echo self::getViewUrl(RevSliderAdmin::VIEW_SLIDER,"id=$sliderID"); ?>" id="rs_breadcrumbs_slider_settings" data-id="<?php echo $sliderID; ?>"><i class="eg-icon-cog"></i><?php _e('Slider Settings', 'revslider');?></a>
...
if ( ! empty($arrSlides)) {
	foreach($arrSlides as $_slide) {
		if ($_slide->getID() == $slideID) continue;
		$mslide_list[] = array($_slide->getID() => $_slide->getTitle());
    }
}
