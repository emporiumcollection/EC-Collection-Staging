...
class RevSliderOperations extends RevSliderElementsBase{
	...
	<head>
        ...
        <?php if ($slider->getParam('typewriter_defaults_enabled', 'false') == 'true') : ?><script type="text/javascript" src="<?php echo $path_css; ?>typewriter.css"></script><?php endif; ?>
...
ob_end_clean();
		...
		$search = array($cont_url, $cont_url_no_www, RS_PLUGIN_URL, 'revslider/', 'url":"');
        ...
        $slider_html = apply_filters('revslider_previewOutputMarkup_before_zip', $slider_html);
