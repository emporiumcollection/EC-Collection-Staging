...
class RevSliderEmbedder {
	...
	public static function jsIncludes($jQueryInclude = true) {
        ...
        if (RevSliderOperations::getGeneralSettingsOptionValue('load_all_javascript', 'off') !== 'off') {
            $output .= '<script type="text/javascript" src="' . RS_PLUGIN_URL . 'public/assets/js/extensions/revolution.extension.actions.min.js' . '"></script>' . "\n";
            $output .= '<script type="text/javascript" src="' . RS_PLUGIN_URL . 'public/assets/js/extensions/revolution.extension.carousel.min.js' . '"></script>' . "\n";
            $output .= '<script type="text/javascript" src="' . RS_PLUGIN_URL . 'public/assets/js/extensions/revolution.extension.kenburn.min.js' . '"></script>' . "\n";
            $output .= '<script type="text/javascript" src="' . RS_PLUGIN_URL . 'public/assets/js/extensions/revolution.extension.layeranimation.min.js' . '"></script>' . "\n";
            $output .= '<script type="text/javascript" src="' . RS_PLUGIN_URL . 'public/assets/js/extensions/revolution.extension.migration.min.js' . '"></script>' . "\n";
            $output .= '<script type="text/javascript" src="' . RS_PLUGIN_URL . 'public/assets/js/extensions/revolution.extension.navigation.min.js' . '"></script>' . "\n";
            $output .= '<script type="text/javascript" src="' . RS_PLUGIN_URL . 'public/assets/js/extensions/revolution.extension.parallax.min.js' . '"></script>' . "\n";
            $output .= '<script type="text/javascript" src="' . RS_PLUGIN_URL . 'public/assets/js/extensions/revolution.extension.slideanims.min.js' . '"></script>' . "\n";
            $output .= '<script type="text/javascript" src="' . RS_PLUGIN_URL . 'public/assets/js/extensions/revolution.extension.video.min.js' . '"></script>' . "\n";
        }
	...
	public static function putRevSlider($data,$putIn = "") {
        ...
        if(!empty($slider)){
            ...
            $content = self::add_styles_and_scripts($slider) . self::load_icon_fonts() . $content;
    ...
    public static function add_styles_and_scripts($slider) {
        ...
        $addons = array(
            ...
            'polyfold'      => $slider->getParam('polyfold_top_enabled', false) == 'true' || $slider->getParam('polyfold_bottom_enabled', false) == 'true',
