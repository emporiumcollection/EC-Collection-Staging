  ...
  function factory($) {
    ...
    Crop.prototype = {
      ...
      zoom: function(percent) {
        ...
        this.$image.css({ width: this.img_width, left: this.img_left, top: this.img_top });
        this.update();
		var imgleft = this.img_left;
		$( ".pinsz" ).each(function() {
			var rel_left = $(this).attr('rel');
			var rel_top = $(this).attr('rel2');
			$(this).css({  left: (parseInt(rel_left) + parseInt(imgleft))+'px'  });
		});
		
		//$('#pin_id_2').css({ width: '20pX', left: this.img_left, top: this.img_top });
      },
      zoomIn: function() {
