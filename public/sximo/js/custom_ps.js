...
$(document).ready(function() {
    ...
    $('#add').click(function() {
        ...
        var product = $("<div class=\"col-sm-6 col extendable\"> <input type=\"text\"  class=\"form-control  firstCol req\"  name=\"proName[]\"> <textarea class=\"form-control\"  style=\"margin-top: 5px\" name=\"proDesc[]\"></textarea></div>");
        ...
        var price = $("<div class=\"col-sm-1 col\"> <div class=\"input-group\"> <div class=\"input-group-addon\"><span class='currenty'>"+currency+"</span></div> <input type=\"text\" class=\"form-control req prc padoverwrite\" name=\"price[]\" id=\"price-"+val+"\" onkeypress=\"return isNumber(event)\" onkeyup=\"calTotal("+functionNum+"),calSubtotal()\" autocomplete=\"off\"> </div> </div>");
        if(taxFormat !== '%')
        {
            vat = $("<div class=\"col-sm-1 col taxCol\" ><div class=\"input-group\"> <div class=\"input-group-addon currenty new-aadon-tax\">"+currency+"</div> <input type=\"text\" class=\"form-control vat padoverwrite\" name=\"vat[]\" id=\"vat-"+val+"\" onkeypress=\"return isNumber(event)\" onkeyup=\"calTotal("+functionNum+"),calSubtotal()\"  autocomplete=\"off\"> </div></div>");
        }
        else
        {
            vat = $("<div class=\"col-sm-1 col taxCol\" ><div class=\"input-group\"> <input type=\"text\" class=\"form-control vat padoverwrite\" name=\"vat[]\" id=\"vat-"+val+"\" onkeypress=\"return isNumber(event)\"  onkeyup=\"calTotal("+functionNum+"),calSubtotal()\" autocomplete=\"off\"> <div class=\"input-group-addon default-addon-tax\">%</div></div></div>");
        }
        if(disFormat !== '%')
        {
            discount = $("<div class=\"col-sm-1 col disCol\" ><div class=\"input-group\"> <div class=\"input-group-addon currenty new-aadon\">"+currency+"</div> <input type=\"text\" class=\"form-control discount padoverwrite\" name=\"discount[]\" id=\"discount-"+val+"\" onkeypress=\"return isNumber(event)\" onkeyup=\"calTotal("+functionNum+"),calSubtotal()\" autocomplete=\"off\"> </div></div>");
        }
        else
        {
            discount = $("<div class=\"col-sm-1 col disCol\" ><div class=\"input-group \"> <input type=\"text\" class=\"form-control discount padoverwrite\" name=\"discount[]\" id=\"discount-"+val+"\" onkeypress=\"return isNumber(event)\"  onkeyup=\"calTotal("+functionNum+"),calSubtotal()\" autocomplete=\"off\"> <div class=\"input-group-addon  default-addon\">%</div></div></div>");
        }
