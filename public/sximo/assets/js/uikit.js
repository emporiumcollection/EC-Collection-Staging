/*! UIkit 2.26.1 | http://www.getuikit.com | (c) 2014 YOOtheme | MIT License */ ! function(t) {
    ...
    if (n.version = "2.26.1", n.noConflict = function() {
                        ...
                        var s, u = i.scrollTop(),
                            h = function() {
                                for (var t = 0; t < e.length; t++)
                                    if (e[t].offset().top + e[t].outerHeight() >= u) return e[t]
                            }();
                        if (!h) return;
