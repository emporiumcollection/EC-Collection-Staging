...
},{"./../../olivie/src/js/jquery":7,"./../../olivie/src/js/olivie":14,"./defaults":16,"./schemes":41,"./yottie":44,"./yottie-facade":43}],19:[function(require,module,exports){
"use strict";
...
module.exports = Olivie.component('Popup', function () {
    ...
    createVideoElement: function () {
        ...
        parts.videoShare = self.renderer.render('popup.video.share', {
            displaying: displaying,
            parts: parts,
            facebookShareLink: 'http://www.facebook.com/sharer.php?u=' + encodeURIComponent('https://www.youtube.com/watch?v=' + self.video.get('id')),
            twitterShareLink: 'https://twitter.com/share?url=' + encodeURIComponent('https://www.youtube.com/watch?v=' + self.video.get('id')) + '&text=' + encodeURIComponent(self.video.get('snippet.title'))
        });
        ...
        parts.videoInfoHeader = self.renderer.render('popup.video.info.header', {
            displaying: displaying,
            parts: parts,
...
},{"./../../../../olivie/src/js/jquery":7,"./../../../../olivie/src/js/olivie":14}],20:[function(require,module,exports){
"use strict";
var $ = require('./../../../../olivie/src/js/jquery'), Olivie = require('./../../../../olivie/src/js/olivie');
...
},{"./../../../../olivie/src/js/jquery":7,"./../../../../olivie/src/js/olivie":14}],21:[function(require,module,exports){
"use strict";
...
},{"./../../../../olivie/src/js/jquery":7,"./../../../../olivie/src/js/olivie":14,"./feed-section":21}],23:[function(require,module,exports){
"use strict";
var $ = require('./../../../../olivie/src/js/jquery'), Olivie = require('./../../../../olivie/src/js/olivie');
...
},{"./../../../../olivie/src/js/jquery":7,"./../../../../olivie/src/js/olivie":14}],26:[function(require,module,exports){
"use strict";
var $ = require('./../../../../olivie/src/js/jquery'), Olivie = require('./../../../../olivie/src/js/olivie');
...
},{"./../../../../olivie/src/js/jquery":7,"./../../../../olivie/src/js/olivie":14}],27:[function(require,module,exports){
"use strict";
var $ = require('./../../../../olivie/src/js/jquery'), Olivie = require('./../../../../olivie/src/js/olivie');
...
},{"./../../../../olivie/src/js/jquery":7,"./../../../../olivie/src/js/olivie":14,"./model":31}],29:[function(require,module,exports){
"use strict";
var $ = require('./../../../../olivie/src/js/jquery'), Olivie = require('./../../../../olivie/src/js/olivie'), Model = require('./model');
module.exports = function (client) {
...
},{"./../../../../olivie/src/js/jquery":7,"./../../../../olivie/src/js/olivie":14,"./model":31}],30:[function(require,module,exports){
"use strict";
var $ = require('./../../../../olivie/src/js/jquery'), Olivie = require('./../../../../olivie/src/js/olivie');
...
},{"./../../../../olivie/src/js/jquery":7,"./../../../../olivie/src/js/olivie":14}],31:[function(require,module,exports){
"use strict";
var $ = require('./../../../../olivie/src/js/jquery'), Olivie = require('./../../../../olivie/src/js/olivie');
...
},{"./../../../../olivie/src/js/jquery":7,"./../../../../olivie/src/js/olivie":14,"./model":31}],33:[function(require,module,exports){
"use strict";
...
},{"./../../../../olivie/src/js/jquery":7,"./../../../../olivie/src/js/olivie":14,"./fetcher":30}],34:[function(require,module,exports){
"use strict";
var $ = require('./../../../../olivie/src/js/jquery'), Olivie = require('./../../../../olivie/src/js/olivie'), Model = require('./model');
module.exports = function (client) {
...
},{"./../../../../olivie/src/js/jquery":7,"./../../../../olivie/src/js/olivie":14,"./model":31}],35:[function(require,module,exports){
"use strict";
var $ = require('./../../../../olivie/src/js/jquery'), Olivie = require('./../../../../olivie/src/js/olivie'), Fetcher = require('./fetcher');
module.exports = function (model) {
...
},{"./../../../../olivie/src/js/jquery":7,"./../../../../olivie/src/js/olivie":14,"./fetcher":30}],36:[function(require,module,exports){
"use strict";
var $ = require('./../../../../olivie/src/js/jquery'), Olivie = require('./../../../../olivie/src/js/olivie');
...
},{"./../../../../olivie/src/js/jquery":7,"./../../../../olivie/src/js/olivie":14}],37:[function(require,module,exports){
"use strict";
var $ = require('./../../../../olivie/src/js/jquery'), Olivie = require('./../../../../olivie/src/js/olivie');
...
},{"./../../../../olivie/src/js/jquery":7,"./../../../../olivie/src/js/olivie":14}],38:[function(require,module,exports){
"use strict";
var $ = require('./../../../../olivie/src/js/jquery'), Olivie = require('./../../../../olivie/src/js/olivie'), Fetcher = require('./fetcher');
module.exports = function (model) {
...
},{"./../../../../olivie/src/js/jquery":7,"./../../../../olivie/src/js/olivie":14,"./fetcher":30}],39:[function(require,module,exports){
"use strict";
var $ = require('./../../../../olivie/src/js/jquery'), Olivie = require('./../../../../olivie/src/js/olivie'), Model = require('./model');
module.exports = function (client) {
...
},{"./../../../../olivie/src/js/jquery":7,"./../../../../olivie/src/js/olivie":14,"./model":31}],40:[function(require,module,exports){
"use strict";
...
},{"./../../../../olivie/src/js/jquery":7,"./../../../../olivie/src/js/olivie":14,"./channel":28,"./comment-thread":29,"./playlist":34,"./playlist-item":32,"./playlist-items-fetcher":33,"./playlists-fetcher":35,"./universal-video-fetcher":37,"./video":39,"./video-fetcher":38}],41:[function(require,module,exports){
"use strict";
module.exports = {
    default: {
        header: {
...
views['popup']['video']['info'] = Handlebars.template({
    '1': function (depth0, helpers, partials, data) {
        var stack1;
        return ' ' + ((stack1 = this.lambda((stack1 = depth0 != null ? depth0.parts : depth0) != null ? stack1.videoInfoHeader : stack1, depth0)) != null ? stack1 : '') + ' ';
    },
    '3': function (depth0, helpers, partials, data) {
        var stack1;
    ...
    'main': function (depth0, helpers, partials, data) {
        var stack1;
        return '<div class="yottie-popup-video-info"> ' + ((stack1 = helpers['if'].call(depth0, (stack1 = depth0 != null ? depth0.displaying : depth0) != null ? stack1.infoHeader : stack1, {
            'name': 'if',
            'hash': {},
            'fn': this.program(1, data, 0),
            'inverse': this.noop,
...
views['popup']['video']['info']['header'] = Handlebars.template({
    '1': function (depth0, helpers, partials, data) {
        var helper;
    ...
    'main': function (depth0, helpers, partials, data) {
        var stack1;
        return '<div class="yottie-popup-video-info-header"> ' + ((stack1 = helpers['if'].call(depth0, (stack1 = depth0 != null ? depth0.displaying : depth0) != null ? stack1.title : stack1, {
            'name': 'if',
            'hash': {},
            'fn': this.program(1, data, 0),
            'inverse': this.noop,
...
views['popup']['video']['info']['meta'] = Handlebars.template({
    ...
    '3': function (depth0, helpers, partials, data) {
        var stack1;
        return ' ' + ((stack1 = this.lambda((stack1 = depth0 != null ? depth0.parts : depth0) != null ? stack1.videoShare : stack1, depth0)) != null ? stack1 : '') + ' ';
    },
    'compiler': [
        6,
        '>= 2.0.0-beta.1'
...
views['popup']['video']['share'] = Handlebars.template({
    'compiler': [
        6,
        '>= 2.0.0-beta.1'
    ],
...
},{"./../../olivie/src/js/jquery":7,"./../../olivie/src/js/olivie":14}],44:[function(require,module,exports){
"use strict";
...
},{"./../../olivie/src/js/jquery":7,"./../../olivie/src/js/modules/appearance/colorizer":8,"./../../olivie/src/js/modules/appearance/i18n":9,"./../../olivie/src/js/modules/appearance/renderer":10,"./../../olivie/src/js/modules/mies/client":12,"./../../olivie/src/js/olivie":14,"./defaults":16,"./dictionary":17,"./modules/popup/popup":19,"./modules/widget/ads":20,"./modules/widget/feed":22,"./modules/widget/groups":24,"./modules/widget/header":25,"./modules/widget/widget":26,"./modules/widget/yt-error":27,"./modules/youtube/youtube":40,"./schemes":41,"./views":42}]},{},[18])