...
s3fs emporium-voyage /var/www/vhosts/emporium-voyage.com/public_html/public/uploads/ -o passwd_file=/etc/passwd-s3fs  -ouid=33,gid=33,allow_other,mp_umask=002
