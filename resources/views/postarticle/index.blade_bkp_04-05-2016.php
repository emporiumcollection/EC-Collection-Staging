...
{!! Form::open(array('url'=>'postarticle/delete/', 'class'=>'form-horizontal' ,'id' =>'SximoTable' )) !!}
	<div class="tab-container tab-left">
		<ul class="nav nav-tabs flat-tabs">
		  <li class="active"><a href="#tab3-1" data-toggle="tab">News</a></li>
		  <li class=""><a href="#tab3-2" data-toggle="tab">Info</a></li>
		  <li class=""><a href="#tab3-3" data-toggle="tab">Presse</a></li>
		</ul>
		<div class="tab-content use-padding">
		  <div class="tab-pane use-padding active" id="tab3-1">
			<div class="table-responsive" style="min-height:300px;">
				<table class="table table-striped ">
					...
					<tbody>   
					@if(array_key_exists(4,$rowData))
						@foreach ($rowData[4] as $row)
							<tr>
								<td width="30"> {{ ++$i }} </td>
		  ...
		  <div class="tab-pane use-padding" id="tab3-3">
			<div class="table-responsive" style="min-height:300px;">
				<table class="table table-striped ">
					...
					<tbody>    
					@if(array_key_exists(3,$rowData))
						@foreach ($rowData[3] as $row)
							<tr>
								<td width="30"> {{ ++$i }} </td>
								<td width="50"><input type="checkbox" class="ids" name="ids[]" value="{{ $row->id }}" />  </td>								
								<td>{{ (!empty($categories)) ? $categories[$row->cat_id] : '' }}</td>
