...
<div class="sbox animated fadeInRight">
	...
	<div class="sbox-content"> 	
		 ...
		 {!! Form::open(array('url'=>'lightboxorders/save?return='.$return, 'class'=>'form-horizontal','files' => true , 'parsley-validate'=>'','novalidate'=>' ')) !!}
<div class="col-md-12">
						<fieldset><legend> Lightbox Orders</legend>
								  ...
								  <div class="form-group  " >
									<label for="Lightbox Id" class=" control-label col-md-4 text-left"> Lightbox Id </label>
									<div class="col-md-6">
									  {!! Form::text('lightbox_id', $row['lightbox_id'],array('class'=>'form-control', 'placeholder'=>'',   )) !!} 
									 </div> 
									 <div class="col-md-2">
				           ...
				           >{{ $row['comments'] }}</textarea> 
								  ...
								  <div class="form-group  " >
									<label for="Reserve Till" class=" control-label col-md-4 text-left"> Reserve Till </label>
									<div class="col-md-6">
									  {!! Form::text('reserve_till', $row['reserve_till'],array('class'=>'form-control', 'placeholder'=>'',   )) !!} 
									 </div> 
									 <div class="col-md-2">
			...
			<div style="clear:both"></div>	
				  ...
				  <div class="form-group">
					...
					<button type="button" onclick="location.href='{{ URL::to('lightboxorders?return='.$return) }}' " class="btn btn-success btn-sm "><i class="fa  fa-arrow-circle-left "></i>  {{ Lang::get('core.sb_cancel') }} </button>
					</div>	  
