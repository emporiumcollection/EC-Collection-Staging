	...
	<div class="page-content-wrapper m-t">	
		<div class="row">
			...
			<div class="col-sm-9">
				<div class="row">
					<div class="col-sm-12">
						<a class="btn btn-primary btn-lg" href="{{ URL::to('folders/').'/'.$prevfolder.'?show='.$showType }}"> {{\Lang::get('core.menu_back')}}</a>
						<a href="#" data-toggle="modal" data-target="#editFile" class="btn btn-primary btn-lg" title="Edit this file">
							{{\Lang::get('core.menu_edit')}}
						</a>
						@if($group==3)
						...
						<!-- Download button -->
						<div class="btn-group">
						  <button type="button" class="btn btn-primary btn-lg">{{\Lang::get('core.menu_functions')}}</button>
						  <button type="button" class="btn btn-primary btn-lg dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
							<span class="caret"></span>
							<span class="sr-only">Toggle Dropdown</span>
						  </button>
						  <ul class="dropdown-menu">
							<!--<li><a href="#" data-toggle="modal" data-target="#newFile"> {{\Lang::get('core.menu_function_add_slider')}}</a></li>
							<li><a href="#" data-toggle="modal" data-target="#addVarients">{{\Lang::get('core.menu_function_add_varient')}}</a></li>-->
							<li><a href="#" data-toggle="modal" data-target="#assignTagsFile">{{\Lang::get('core.menu_function_add_tag')}}</a></li>
						  </ul>
						</div>
