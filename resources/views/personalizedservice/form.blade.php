                ...
                <div class="col-md-12">
                    <fieldset><legend> Personalizedservice</legend>
                        ...
                        <div class="form-group  " >
                            ...
                            <div class="col-md-6">
                                <textarea name='note' rows='5' id='note' class='form-control '>{{ $row['note'] }}</textarea> 
                            </div> 
                            <div class="col-md-2">
                            </div>
                        </div>
                                ...
                                <select class="form-control" name="reservation_agent">
                                    ...
                                    if (!empty($reservation_agents)) {
                                        foreach ($reservation_agents as $reservation_agent) {
                                            echo '<option ', ($reservation_agent->id == $row['reservation_agent']) ? 'selected' : '', ' value="' . $reservation_agent->id . '">' . trim($reservation_agent->first_name.' '.$reservation_agent->last_name) . '</option>';
                                        }
                                    }
                                    ?>                                                                                
                                </select>
                        ...
                        <div class="form-group" >
                            ...
                            <div class="col-md-6">
                                <select class="form-control" name="status">
                                    ...
                                    <option <?php echo ($row['status'] == 'In-Progress')? 'selected' : ''; ?> value="In-Progress">In-Progress</option>
                                    <option <?php echo ($row['status'] == 'Waiting confirmation')? 'selected' : ''; ?> value="Waiting confirmation">Waiting confirmation</option>
                                    <option <?php echo ($row['status'] == 'Confirmed')? 'selected' : ''; ?> value="Confirmed">Confirmed</option>
                                </select>
                            </div> 
                            <div class="col-md-2">
                            </div>
