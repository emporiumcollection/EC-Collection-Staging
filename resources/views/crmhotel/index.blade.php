					 ...
					 @if($field['view'] =='1')
						 ...
						 {{--*/ $vfield = $field['field']; /*--}}
						 	@if($field['attribute']['image']['active'] =='1')
								{!! SiteHelpers::showUploadedFile($row->$vfield,$field['attribute']['image']['path']) !!}
							@else	
								{{--*/ $conn = (isset($field['conn']) ? $field['conn'] : array() ) /*--}}
								{!! SiteHelpers::gridDisplay($row->$vfield,$field['field'],$conn) !!}	
							@endif						 
						 </td>
						@endif	
					 @endif					 
		...
		<div class="popup-content">
			...
			<div class="email-tabs-outer">
				<div class="white-bar-menu-outer">
					<ul class="nav nav-pills email-pop-up-tabs">
						<li class="active"><a data-toggle="pill" href="#email-tab1">{{ Lang::get('core.crmhotel_email_popup_emailtab') }}</a></li>
						<li><a data-toggle="pill" href="#email-tab2">{{ Lang::get('core.crmhotel_email_popup_emaillist') }}</a></li>
					</ul>
				</div>
							...
							<div class="container">
								...
								<div class="col-md-6">
									<div class="email-form-outer">
										{!! Form::open(['url' => '#','method'=>'post','id'=>'emailcrm']) !!}
