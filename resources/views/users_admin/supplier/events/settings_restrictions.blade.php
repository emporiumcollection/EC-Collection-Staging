					...
					<div class="tab-pane active">
                        <div class="row">
                            <div class="col-sm-12 col-md-12 col-lg-12">
                                <h3 class="main-heading">Restrictions {{-- Lang::get('hotel-property.type-heading')--}}</h3>
                            </div>
                        </div>  
                        <div class="row">
                            <div class="col-md-12 col-xs-12">
                                <div class="m-alert m-alert--icon m-alert--icon-solid m-alert--outline alert alert-danger alert-dismissible fade show" role="alert">
                                   ...
                                   <div class="m-alert__text">                
                                        Restrictions let you apply special conditions to reservations. They'll appear on your property's reservation page, see more details on setting up restrictions.{{-- Lang::get('hotel-property.type-info')--}}
                                   </div>
                                </div>
                            </div>
                        </div>
