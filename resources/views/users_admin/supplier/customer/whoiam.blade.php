...
<!--begin: Form Wizard Nav -->
									<div class="m-wizard__nav">
										<div class="m-wizard__steps">
                                            ...
                                            <div class="m-wizard__step" m-wizard-target="m_wizard_form_step_5" class="wizard_step_6">
												<div class="m-wizard__step-info">
													<a href="#" class="m-wizard__step-number">
														<span>
															<span>
                                                ...
                                                <div class="m-form__section">
                                                   ...
                                                   <div class="form-group m-form__group row">
                                                    ...
                                                    <div class="form-group m-form__group row">
    													...
    													<div class="col-xl-9 col-lg-9">
    														<input name="company_city" type="text" id="company_city" class="form-control m-input m-input--solid" value="{{isset($company_details->company_city) ? $company_details->company_city : ''}}" />  
    													</div>
    												</div>
                                                    <div class="form-group m-form__group row">
    													<label class="col-xl-3 col-lg-3 col-form-label">
...
Select the Commission Terms you wish to agree with.                                                             <hr />
                                                        ...
                                                        <div class="col-xl-12 col-sm-12 col-md-12 col-lg-12">
                                                            ...
                                                            <div class="m-radio-list">
                                    							<label class="m-radio">
                                    							     <input type="radio" name="supplier_commission_type" value="0" <?php echo $user->supplier_commission_type==0 ? 'checked="checked"' : ''; ?> />
                                                                        Yearly Membership
                                                                     <span></span>
                                    							</label>
                                                                <label class="m-radio">
                                    							     <input type="radio" name="supplier_commission_type" value="1" <?php echo $user->supplier_commission_type==1 ? 'checked="checked"' : ''; ?> />
                                                                        Commissionalbe Price ( <?php echo (float) isset($default_commission->content) ? $default_commission->content : 5.00 ;?>%)
                                                                     <span></span>
                                    							</label>
                                    						</div>  
                                                            <?php //} ?>                                                                                                                 
                        ...
                        {{--*/ if($alreadyAccepted !== true){ $new_contract_ava = true; } /*--}}
                                                        ...
                                                        <div class="col-xl-12 col-sm-12 col-md-12 col-lg-12 margin-top" id="dv_contract_view_download" @if($new_contract_ava) style="display: none;" @else style="display: '';" @endif >
                                                            <div class="form-group m-form__group row">
                                                                ...
                                                                <div class="col-xl-9 col-lg-9">                                                
                                                                    <a href="{{ URL::to('user/suppliercontractflipbook')}}" title="View Contract" class="m-btn btn btn-primary" target="_blank"><i class="la la-eye"></i>View Contract</a>
                                                                </div>
                                                            </div>
                                                            <div class="form-group m-form__group row">
                                                                <label class="col-xl-2 col-lg-2 col-form-label">
                                                                ...
                                                                <div class="col-xl-9 col-lg-9">                                                
                                                                    ...
                                                                    <a href="{{ URL::to('supplier-contract/download')}}" title="Download contract to proceed" class="m-btn btn btn-success" target="_blank" id="btn_download"><i class="la la-file-pdf-o"></i>Download Contract</a>
                                            ...
                                            <div class="m-wizard__form-step" id="m_wizard_form_step_5">
                                                <input name="form_wizard_6" type="hidden" id="form_wizard_5" value="5" />  
    											<div class="m-form__section">
                                                            						...
                                                            						<div class="m-accordion__item">
                                                            							...
                                                            							<div class="m-accordion__item-body <?php echo ($m==0) ? 'show' : 'collapse' ?>" id="m_accordion_3_item_membership_{{ $k }}_body" class=" " role="tabpanel" aria-labelledby="m_accordion_3_item_membership_{{ $k }}_head" data-parent="#m_accordion_3_membership">
                                                                                            ...
                                                                                            <div class="row" style="margin-top: 10px;">
                                                                                                ...
                                                                                                <div class="col-xl-8 col-sm-8 col-md-8 col-lg-8" style="display: none;">
                                                                                                    @if(CNF_SUBTRACT_FEE)
    			...
    			<div class="modal-body">
                    <div class="m-portlet m-portlet--full-height">                        
                        <div class="m-portlet__body">
                            ...
                            <div class="m-accordion m-accordion--default m-accordion--solid" id="commission_accordion" role="tablist">
                                ...
                                <?php
                                    if(!empty($commision_contractdata)) {
                                        foreach($commision_contractdata as $si_commision_contractdata)
                                ?>
                                    
                                <!-- contracts start -->
                                    <div class="m-accordion__item">
                                        <div class="m-accordion__item-head collapsed" role="tab" id="contract_accordion_item_{{$si_commision_contractdata->contract_id}}_head" data-toggle="collapse" href="#contract_accordion_item_{{$si_commision_contractdata->contract_id}}_body" aria-expanded="false">
                                            ...
                                            <span class="m-accordion__item-title">{{$si_commision_contractdata->title}}</span>
                                            <span class="m-accordion__item-mode"></span>
                                        </div>
                                        
                                        <div class="m-accordion__item-body collapse" id="contract_accordion_item_{{$si_commision_contractdata->contract_id}}_body" role="tabpanel" aria-labelledby="contract_accordion_item_{{$si_commision_contractdata->contract_id}}_head" data-parent="#commission_accordion">
                                            <div class="m-accordion__item-content">
                                                <?php echo $si_commision_contractdata->description; ?>
                                            </div>
                                        </div>
                                    </div>
                                <!-- contracts end -->
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-md-12">
                                    Please confirm the commission contract to proceed to the next step by selecting all the required section by approving. 
                                </div>
                            </div>
                        </div>
                    </div>                				
    ...
    <script>
        ...
        $(document).ready( function () {  
            ...
            $("#continue_btn").click(function(e){
                e.preventDefault();                                              
                $.ajax({
                    url:base_url+'/supplier/get_cart', 
                    type:'get',    
            ...
            $(document).on('click','#checkout_btn',function(e){
                e.preventDefault();
                $.ajax({
                    url:base_url+'/supplier/get_checkout', 
                    type:'get',
        ...
        function addToCartHotel(PackageID,PackagePrice){    
            ...
            xhttp.open("GET", "{{ URL::to('supplier/add_package_to_cart_wizard')}}?cart[package][id]="+PackageID+"&cart[package][price]="+PackagePrice+"&cart[package][qty]=1&cart[package][type]=supplier&cart[package][fee]="+fee_subtract_on_booking, true);
            xhttp.send();
        ...
        function removeItemFromCart(PackageID){    
            ...
            xhttp.open("GET", "{{ URL::to('removesuppliercartitem')}}?cart[package][id]="+PackageID+"&cart[package][qty]=1&cart[package][type]=supplier", true);
            xhttp.send();
        ...
        $(document).on('click', '#back_checkout_btn', function(e){
            e.preventDefault();
            $("#dv_pkg").css('display', '');
            $("#cart_row").css('display', 'none');    
        });
...
@section('script')
    ...
    <script src="{{ asset('metronic/assets/demo/demo6/base/supplier_wizard.js') }}"></script>
