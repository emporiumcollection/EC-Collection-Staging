                	...
                	<div 
						...
						<ul class="m-menu__nav  m-menu__nav--dropdown-submenu-arrow ">
                            ...
                            <li class="m-menu__item  m-menu__item--submenu" aria-haspopup="true"  m-menu-submenu-toggle="hover">
                                <a href="{{ URL::to('dashboard')}}" class="m-menu__link"><i class="m-menu__link-icon flaticon-imac"></i> <span class="m-menu__link-text">Dashboard</span></a>
                            </li>
                             ...
                             <li class="m-menu__item m-menu__item--submenu m-menu__item" aria-haspopup="true" m-menu-submenu-toggle="hover">
                                    ...
                                    <div class="m-menu__submenu " m-hidden-height="80" style="">
                                        ...
                                        <ul class="m-menu__subnav">
                                            ...
                                            <li class="m-menu__item " aria-haspopup="true" m-menu-link-redirect="1">
                                                <a href="{{ URL::to('eventpackages') }}" class="m-menu__link">                                                    
                                                    <i class="m-menu__link-icon flaticon-graphic-2"></i>
                                                    <span class="m-menu__link-text">
                                                        Event Packages
                                                    </span>
                                            ...
                                            <li class="m-menu__item " aria-haspopup="true" m-menu-link-redirect="1">
                                                <a href="{{ URL::to('eventreservations') }}" class="m-menu__link">                                                    
                                                    <i class="m-menu__link-icon flaticon-graphic-2"></i>
                                                    <span class="m-menu__link-text">
                                                        Event Reservations
                                                    </span>
