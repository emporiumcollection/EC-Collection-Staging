					...
					<div class="tab-pane active">
                        <div class="row">
                            <div class="col-sm-12 col-md-12 col-lg-12">
                                <h3 class="main-heading">Options {{-- Lang::get('hotel-property.type-heading')--}}</h3>
                            </div>
                        </div>  
                        <div class="row">
                            <div class="col-md-12 col-xs-12">
                                <div class="m-alert m-alert--icon m-alert--icon-solid m-alert--outline alert alert-danger alert-dismissible fade show" role="alert">
                                   ...
                                   <div class="m-alert__text">                
                                        Please add the new options you wish to associate with the room, For instance Baby Cot. Select the option show on Booking Platform if you want the guest to be able to directly select the option at time of the booking, Infants require a baby cot. Be sure to associate the option with the appropriate Suite Type.{{-- Lang::get('hotel-property.type-info')--}}
                                   </div>
                                </div>
                            </div>
                        </div>
