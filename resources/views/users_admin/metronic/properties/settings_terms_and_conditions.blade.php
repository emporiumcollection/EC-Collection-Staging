                                ...
                                <div class="row">
                                            ...
                                            <div class="m-checkbox">
    											<label class="m-checkbox m-checkbox--solid m-checkbox--brand">
    												<input type="checkbox" <?php echo isset($row->applytoallroomtypes)? ($row->applytoallroomtypes==1 ? 'checked="checked"' : '') : '' ?> name="termsapplytoallroomtypes" value="1">
                                                    Terms apply to all room types
    												<span></span>
    											</label>
    										</div>
