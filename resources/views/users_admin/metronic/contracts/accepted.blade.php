...
@section('page_name')
    Accepted Contracts  <small></small>
@stop
...
@section('breadcrumb')
    ...
    <li class="m-nav__item"> 
        <a href="javascript:;" class="m-nav__link"> 
            <span class="m-nav__link-text"> Accepted Contracts </span> 
        </a> 
    </li>
@stop
...
@section('content')
    ...
    <div class="m-portlet m-portlet--mobile">
        ...
        <div class="m-portlet__body">
            @if(count($rowData) > 0)
                <button data-toggle="modal" data-target="#sximo-modal" class="btn btn-md btn-info" style="margin-bottom: 10px;"><i class="fa fa-search"></i> Search</button>
            @endif
