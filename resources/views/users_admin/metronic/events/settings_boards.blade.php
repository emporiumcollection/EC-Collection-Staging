					...
					<div class="tab-pane active">
                        <div class="row">
                            <div class="col-sm-12 col-md-12 col-lg-12">
                                <h3 class="main-heading">Boards {{-- Lang::get('hotel-property.type-heading')--}}</h3>
                            </div>
                        </div>  
                        <div class="row">
                            <div class="col-md-12 col-xs-12">
                                <div class="m-alert m-alert--icon m-alert--icon-solid m-alert--outline alert alert-danger alert-dismissible fade show" role="alert">
                                   ...
                                   <div class="m-alert__text">                
                                        In this section we will add the Board Types for your hotel. Full board includes bed, breakfast, packed lunch and evening meal. Half Board includes bed, breakfast and evening meal (no packed lunch). Bed and breakfast includes bed and breakfast only. Hotel board arrangements with a meal timetable are shown on all quotes and invoicing:{{-- Lang::get('hotel-property.type-info')--}}
                                   </div>
                                </div>
                            </div>
                        </div>
