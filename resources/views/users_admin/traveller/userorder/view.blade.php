    ...
    <div class="col-sm-12 col-md-12 col-xl-12">    
        ...
        <div class="m-portlet m-portlet--mobile">
            <div class="m-portlet__head">
                ...
                <div class="m-portlet__head-tools"><a href="{{ URL::to('traveller/invoices') }}" class="btn btn-primary btn-md" title="{{ Lang::get('core.btn_back') }}"><i class="fa fa-arrow-circle-left"></i>&nbsp;Back</a> </div>
            </div>
