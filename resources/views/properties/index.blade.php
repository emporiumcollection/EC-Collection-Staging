...
<div class="sbox-tools" >
	...
	<div class="sbox-content"> 	
	    <div class="toolbar-line ">
			...
			<a href="#" onclick="select_field_changeType('Villas');" class="tips btn btn-sm btn-white" title="{{ Lang::get('core.btn_group') }}">
				<i class="fa fa-group"></i>&nbsp;Villas </a>
			<a href="#" onclick="select_field_changeType('Yachts');" class="tips btn btn-sm btn-white" title="{{ Lang::get('core.btn_tab') }}">
			<i class="fa fa-group"></i>&nbsp;Yachts </a>
		</div> 		
