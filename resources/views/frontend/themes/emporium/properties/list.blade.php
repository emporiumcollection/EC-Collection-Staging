                                  ...
                                  <div class="col-md-12 col-sm-12 col-xs-12 grid-item">
							        <div class="row">
							           <div class="gridinner">
							            ...
							            <a href="{{ $url }}" title="{{ $props->property_name}}">
							          		  <img src="{{ URL::to('themes/emporium/images/emporium-voyage-logo-white-loader.svg') }}" data-src="{{ URL::to('propertyimagebyid/'.$props->id)}}" class="img-responsive rad-img" alt="{{ $props->property_name}}" title="{{ $props->property_name}}" data-ajax-link="{{ URL::to('ajax-rproperty-images/'.$props->id.'/3') }}" />
							               {{-- URL::to('propertyimagebyid/'.$props->id)--}}
							           	</a>
