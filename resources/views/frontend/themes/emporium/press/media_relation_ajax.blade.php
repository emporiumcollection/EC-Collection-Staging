...
<div id="allmodal">
	...
	{!! Form::open(array('url'=>'pressseletedfileszip', 'class'=>'columns' ,'id' =>'file_download', 'method'=>'post' )) !!}
		<input type="hidden" name="selectedfiles" class="selectedfiles" value="">
		<input type="hidden" name="curnurl" value="{{ Request::url().'?show='.$showType }}">
	</form>
	
	<!-- Selected Files/Folder downloaded as Low PDF -->
	{!! Form::open(array('url'=>'pressseletedfileslowPdf', 'class'=>'columns' ,'id' =>'lowpdf_download', 'method'=>'post' )) !!}
		<input type="hidden" name="selectedfiles" class="selectedfiles" value="">
		<input type="hidden" name="fold_id" value="{{$fid}}">
		<input type="hidden" name="curnurl" value="{{ Request::url().'?show='.$showType }}">
	</form>
	...
	{!! Form::open(array('url'=>'pressseletedfileshighPdf', 'class'=>'columns' ,'id' =>'highpdf_download', 'method'=>'post' )) !!}
		<input type="hidden" name="selectedfiles" class="selectedfiles" value="">
		<input type="hidden" name="fold_id" value="{{$fid}}">
		<input type="hidden" name="curnurl" value="{{ Request::url().'?show='.$showType }}">
	</form>
