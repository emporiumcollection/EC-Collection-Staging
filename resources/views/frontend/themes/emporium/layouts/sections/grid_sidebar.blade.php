...
<div class="mobilemenu">
    ...
    <div class="mobilemenu-inner">
        <div class="mobilemainnav openmobilemenu">
            <div class="mobilenavheader"><a href="index.html"><img src="{{ assests('images/logo.png') }}" alt="Emporium Voyage" class="img-responsive"/></a></div>
            <ul class="mobilemenulist">
                ...
                <li><a href="javascript:void(0)" class="searchbyfilter">FILTER BY PRICE</a></li>
        ...
        <div class="searchbydatenav">
            ...
            <ul class="mobilemenulist">
                ...
                <li>
                    ...
                    <button class="searchButton btn" type="button">Update Dates</button>
                    <div class="clearfix"></div>
                </li>
            </ul>
