	   ...
	   @section('sidebar')
		@parent
         <div class="sidebar-nav">
            <div class="navbar navbar-default" role="navigation">
               ...
               <div class="navbar-collapse sidebar-navbar-collapse">
                  <ul class="nav navbar-nav" id="sidenav01">
                     <li><a class="searchourcollectonlink" href="javascript:void(0)">SEARCH OUR COLLECTION</a></li>
                     <li><a class="searchByDateButton" href="javascript:void(0)">SEARCH BY DATE</a></li>
                     <li>
                        <a href="javascript:void(0)" class="yourdestinationpopupButton">SELECT YOUR DESTINATION</a>
                     </li>
                     <li>
                        <a href="javascript:void(0)" class="yourexperiencepopupButton">SELECT YOUR EXPERIENCE</a>
                     </li>
                     <li>
                        <a href="javascript:void(0)">PERSONALIZED SERVICE</a>
                     </li>
                     <li>
                        <a data-toggle="collapse" data-parent="#accordion" href="#collapse3" class="collapsed">COMPANY</a>
                        <div class="collapse" id="collapse3" style="height: 0px;">
            ...
            <div class="clearall">
               <a href="javascript:void(0)"><i class="fa fa-rotate-right "></i> Clear All</a>
            </div>
