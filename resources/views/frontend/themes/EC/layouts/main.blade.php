...
<script>
    ...
    var depDt = new Date();
    console.log(arriveDt);        
    @if(!empty($arrive_date))                      
        arriveDt = '{{$arrive_date}}';
    @else               
        arriveDt = arriveDt;            
    @endif
            
    @if(!empty($departure_date))                
        depDt = '{{$departure_date}}'; 
    @else               
        depDt = depDt.getDate()+1;        
    @endif
    
    console.log(arriveDt);
    
    $(".cal-f .cal-date").html("ddaa");   
    function rangeChanged(target,range){ console.log(range); console.log(target); 
