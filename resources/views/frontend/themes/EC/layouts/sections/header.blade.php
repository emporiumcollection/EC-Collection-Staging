<header>
  <div class="container-fluid py-3 header-container">
    ...
    <div class="row align-items-end">
      ...
      <div class="col-3 text-right">
        ...
        <div class="d-flex justify-content-end align-items-center">
          <div class="mr-4">
            <a href="#" class="color-primary">Get Inspired</a>
          </div>
          <!-- <div class="mr-3">
            <div class="dropdown">
          ...
          <div class="menu">
            <a href="#" class="close-menu">
              <svg fill="currentColor"
                focusable="false" height="40px" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
                <title>Close</title>
                <path
