...
<div class="sbox animated fadeInRight">
	...
	<div class="sbox-content"> 	
		 ...
		 {!! Form::open(array('url'=>'pagesslider/save?return='.$return, 'class'=>'form-horizontal','files' => true , 'parsley-validate'=>'','novalidate'=>' ')) !!}
<div class="col-md-12">
						<fieldset><legend> Pages Slider</legend>
								  ...
								  <div class="form-group  " >
									<label for="Slider Page" class=" control-label col-md-4 text-left"> Slider Page <span class="asterix"> * </span></label>
									<div class="col-md-6">
									  <select name='slider_page_id' rows='5' id='slider_page_id' class='select2 ' required  ></select> 
									 </div> 
									 <div class="col-md-2">
			...
			<div style="clear:both"></div>	
				  ...
				  <div class="form-group">
					...
					<button type="button" onclick="location.href='{{ URL::to('pagesslider?return='.$return) }}' " class="btn btn-success btn-sm "><i class="fa  fa-arrow-circle-left "></i>  {{ Lang::get('core.sb_cancel') }} </button>
					</div>	  
