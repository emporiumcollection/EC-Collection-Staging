		...
		<div class="sbox animated fadeInRight">
			...
			<div class="sbox-content">
                ...
                <ul class="nav nav-tabs">
                    <li class="active"><a href="#SpaDetails" data-toggle="tab">Spa Details</a></li>
                    @if($id)
                ...
                <div class="tab-content">
                    <div class="tab-pane m-t active" id="SpaDetails">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane m-t active" id="SubtabRestaurantDetails">
                				...
                				<div class="col-md-12">
                					...
                					<div class="form-group  " >
                						<label for="Spa Manager" class=" control-label col-md-4 text-left"> Spa Manager </label>
                						<div class="col-md-6">
                							{!! Form::text('spa_manager', $row['spa_manager'],array('class'=>'form-control', 'placeholder'=>'',   )) !!}
                						</div>
                						<div class="col-md-2">
                ...
                <div class="tab-pane m-t" id="GalleryImages">
					...
					<form id="fileuploadgalleryimages" class="fileupload" action="{{URL::to('spa_images_uploads')}}" method="POST" enctype="multipart/form-data">
						...
						<div class="row fileupload-buttonbar">
							<div class="col-lg-7">
								...
								<button type="button" class="btn btn-danger" onclick="delete_spa_selected_imgs('sgi');" >
                ...
                <div class="tab-pane m-t" id="SliderImages">
                    <!-- The file upload form used as target for the file upload widget -->
					<form id="fileuploadsliderimages" class="fileupload" action="{{URL::to('spa_images_uploads')}}" method="POST" enctype="multipart/form-data">
						<input type="hidden" name="propId" value="{{$row['id']}}" />
                ...
                <div class="tab-pane m-t" id="Menu">
                    <!-- The file upload form used as target for the file upload widget -->
					<form id="fileuploadmenu" class="fileupload" action="{{URL::to('spa_images_uploads')}}" method="POST" enctype="multipart/form-data">
						<input type="hidden" name="propId" value="{{$row['id']}}" />
									...
									@foreach($res_menu as $img)
										<tr class="template-download fade in row{{$img->id}}">
											...
											<td>
                                                ...
                                                <button type="button" class="btn btn-danger" onclick="add_spa_menu_title({{$img->id}});" >
													<i class="glyphicon glyphicon-plus"></i>
...
<script> var baseUrl = "{{URL::to('spa_images_uploads')}}"; </script>
...
<script>
    ...
    function add_spa_menu_title(mid){
        
        $.ajax({
            url: "{{ URL::to('spa/menutitle')}}",
            type: "get",
            data: {mid:mid},
            dataType: "json",
            success: function(data){
	...
	function delete_spa_image(imgID)
	{
		if(imgID!='' && imgID>0)
		{
	...
	function delete_spa_selected_imgs(cls)
	{
		var conf = confirm("Are you sure? you want to delete this record!");
		if(conf==true)
		{
			...
			$.ajax({
			  url: "{{ URL::to('spa/deletespaselectedimage')}}",
			  type: "post",
			  data: "items=" + sList,
			  dataType: "json",
			  success: function(data){
