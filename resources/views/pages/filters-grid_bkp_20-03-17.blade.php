                ...
                <li class="active select-all">
                    <a href="javascript:void(0)">
                        <div class="filter-bg">
                            ...
                            <div class="top-filter-name">All Categories</div>
                        </div>
                    </a>
                </li>
                <li>
                    <a href="javascript:void(0)">
                        <div class="filter-bg">
                            ...
                            <div class="clearfix"></div>
                            <div><i class="fa fa-home" aria-hidden="true"></i></div>
                            <div class="top-filter-name">Hotels</div>
                        </div>
                    </a>
                </li>
                <li>
                    <a href="javascript:void(0)">
                        <div class="filter-bg">
                            ...
                            <div class="clearfix"></div>
                            <div><i class="fa fa-home" aria-hidden="true"></i></div>
                            <div class="top-filter-name">Villas</div>
                        </div>
                    </a>
                </li>
                <li>
                    <a href="javascript:void(0)">
                        <div class="filter-bg">
                            ...
                            <div class="clearfix"></div>
                            <div><i class="fa fa-home" aria-hidden="true"></i></div>
                            <div class="top-filter-name">Yachts</div>
                        </div>
                    </a>
                </li>
                <li>
                    <a href="javascript:void(0)">
                        <div class="filter-bg">
                            ...
                            <div class="clearfix"></div>
                            <div><i class="fa fa-home" aria-hidden="true"></i></div>
                            <div class="top-filter-name">Experience</div>
                        </div>
                    </a>
                </li>
                <li>
                    <a href="javascript:void(0)">
                        <div class="filter-bg">
                            ...
                            <div class="clearfix"></div>
                            <div><i class="fa fa-home" aria-hidden="true"></i></div>
                            <div class="top-filter-name">Magazine</div>
                        </div>
                    </a>
                </li>
            </ul>
...
<script>
    $(document).ready(function(){
        $('.top-bar-filters li.select-all').click(function(){
        ...
        $('.top-bar-filters li').click(function(){
            if(!$(this).hasClass("select-all")) {
                $(this).toggleClass("active");
                $('.top-bar-filters li.select-all').removeClass("active");
            }
        });
        $('.clear-all-filters a').click(function( event ){
	...
	function filter_destination(destn)
	{
		if(destn!='' && destn>0)
		{
			$.ajax({
