                            ...
                            <div class="image-slider-container image-slider-margin-align auto-slider" id="rooms">
                                <ul class="image-slider">
                                    ...
                                    <li class="{{($propertyDetail['typedata'][0]==$type) ? 'active' : ''}}">
                                        <a href="#">
                                            <img class="img-responsive" src="{{$propertyDetail['roomimgs'][$type->id][0]->imgsrc.$propertyDetail['roomimgs'][$type->id][0]->file_name}}" alt="{{$propertyDetail['roomimgs'][$type->id][0]->file_name}}" style="height:580px; width: 100%;">
                                        </a>
                                    ...
                                    <div class="col-md-12 col-sm-12">
                                        <div class="col-md-6 col-sm-6 hotels-des-left-side">
                                                <div class="hotels-detail-heading-text">
                                                    <p>Luxury Location Miss Calra By Nobis Stockholm, Sweden Stockholm, sweden</p>
                                                </div>
                                                <div class="hotels-detail-description-text">
                                                    <p>
                                                        Situated in Norrmalm, this eco-friendly resort
                                                        is inside a 15-minute stroll of Stockholm Metropolis
                                                        Situated in Norrmalm, this eco-friendly resort
                                                        is inside a 15-minute stroll of Stockholm Metropolis
                                                        Situated in Norrmalm, this eco-friendly resort
                                                        is inside a 15-minute stroll of Stockholm Metropolis
