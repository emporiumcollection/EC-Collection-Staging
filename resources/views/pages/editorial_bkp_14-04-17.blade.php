                    ...
                    <section class="book-form-top-bar">
                        <div>
                            <div class="to-booking-nav-show-hide-btn">
                                <img src="{{ asset('sximo/assets/images/header-rigth-arrow.png')}}" alt=""/>
                            </div>
                            <form>
                        ...
                        <ul>
                            ...
                            <li class="{{($propertyDetail['propimage'][0]==$propimg) ? 'active' : ''}}">
                                ...
                                <div class="editorial-text">
                                    ...
                                    <div class="description-bold-text">{{ (strlen($propertyDetail['data']->about_property) > 130) ? substr($propertyDetail['data']->about_property,0,130) : $propertyDetail['data']->about_property }}</div>
                                    <!--end slide -->
                                </div>
                            </li>
                            @endif
                                ...
                                <div class="book-now-page-content-">
                                    ...
                                    <ul class="dates" id="editorial-book-now-inputs">
                                        <li>
                                            ...
                                            <input id="date-range-editorial-arrive" name="booking_arrive" class="datePicker- dateFrom-" value="01.01.2017" type="text" />
                                        </li>
                                        <li>
                                            <div class="heading">Departure</div>
                                            <input id="date-range-editorial-destination" name="booking_destination" class="datePicker- dateFrom-" value="02.01.2017" type="text" />
                                        </li>
                                    </ul>
                                    <ul class="dates">
                                        <li>
