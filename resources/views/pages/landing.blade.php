...
/*            html {
    ...
    /* number select dropdawn buttons */
    .members-drop-list {
  position: relative;
}
...
.members-drop-list input:focus {
  outline: 0;
}

.members-drop-list-nav {
  float: left;
  position: relative;
  height: 42px;
}

.members-drop-list-button {
  position: relative;
  cursor: pointer;
...
.members-drop-list-button.members-drop-list-up {
  position: absolute;
  height: 50%;
  top: 0;
...
.members-drop-list-button.members-drop-list-down {
  position: absolute;
  bottom: -1px;
  height: 50%;
}
