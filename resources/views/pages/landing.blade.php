    ...
    <head>
        ...
        <style>
            #search-navbar.search-navbar-destination-search-box {
                ...
                border: 2px solid #2a2d30 !important;
                margin-left: 96px;
                width: 80% !important;
            }
                        ...
                        <div class="col-md-6">
                            <div class="left-serach">
                                ...
                                <div class="serach-page-menu">
                                    <ul>
                                        <li><a href="{{URL::to('luxurytravel/Hotel?ref=oc
')}}">Hotels</a></li>
                    ...
                    <div class="choose-experience-center-align">
                        <div class="width-100 holiday-type-image-align ">
                            <div class="width-20">
                                ...
                                <a href="{{URL::to('search?s=Beach Hotels&ref=sye')}}"><h3 class="hover-tittles">Go Beach Hotels</h3></a>
                            </div>
                            <div class="width-20">
                                <img class="img-responsive" src="{{ asset('sximo/assets/images/GoGreen2.jpg')}}" alt=""/>
                                <a href="{{URL::to('search?s=Green Properties&ref=sye')}}"><h3 class="hover-tittles">Go Green Hotels</h3></a>
                            </div>
                            <div class="width-20">
                                <img class="img-responsive" src="{{ asset('sximo/assets/images/GoUrban2.jpg')}}" alt=""/>
                                <a href="{{URL::to('search?s=Go Urban Hotels&ref=sye')}}"><h3 class="hover-tittles">Go Urban Hotels</h3></a>
                            </div>
                            <div class="width-20">
                                <img class="img-responsive" src="{{ asset('sximo/assets/images/InfinityPools2.jpg')}}" alt=""/>
                                <a href="{{URL::to('search?s=Infinity Pools&ref=sye')}}"><h3 class="hover-tittles">Go Infinity Pools</h3></a>
                            </div>
                            <div class="width-20">
                                <img class="img-responsive" src="{{ asset('sximo/assets/images/WellnessHotels3.png')}}" alt=""/>
                                <a href="{{URL::to('search?s=Spa & Wellness Hotels&ref=sye')}}"><h3 class="hover-tittles">Go Spa & Wellness Hotels</h3></a>
                            </div>
                            <div class="width-20">
                                <img class="img-responsive" src="{{ asset('sximo/assets/images/MountainAndSki2.jpg')}}" alt=""/>
                                <a href="{{URL::to('search?s=Mountain Ski Resorts&ref=sye')}}"><h3 class="hover-tittles">Go Mountains and Skin Resorts</h3></a>
                            </div>
                            <div class="width-20">
                                <img class="img-responsive" src="{{ asset('sximo/assets/images/YogaHotels3.jpg')}}" alt=""/>
                                <a href="{{URL::to('search?s=Yoga Hotels&ref=sye')}}"><h3 class="hover-tittles">Discover Yoga Hotels</h3></a>
                            </div>
                            <div class="width-20">
                                <img class="img-responsive" src="{{ asset('sximo/assets/images/CulinaryDelights.jpg')}}" alt=""/>
                                <a href="{{URL::to('search?s=Culinary Delights&ref=sye')}}"><h3 class="hover-tittles">Discover culinary Delight Hotels</h3></a>
                            </div>
                            <div class="width-20">
                                <img class="img-responsive" src="{{ asset('sximo/assets/images/FamilyFriendly-1.jpg')}}" alt=""/>
                                <a href="{{URL::to('search?s=Family Friendly&ref=sye')}}"><h3 class="hover-tittles">Discover Family Friendly Hotels</h3></a>
                            </div>
                            <div class="width-20">
                                <img class="img-responsive" src="{{ asset('sximo/assets/images/UnusualAdventures.jpg')}}" alt=""/>
                                <a href="{{URL::to('search?s=Unusual Adventure Hotels&ref=sye')}}"><h3 class="hover-tittles">Unusual Adventure Hotels</h3></a>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div id="collapse-inner{{$destination['maincat']->id}}" class="panel-collapse collapse ">
                                <div class="panel-body">
                                    <ul class="where-box-sub-menu">
                                        ...
                                        <li><a href="{{URL::to('search?continent='.$destination['maincat']->category_name.'&region='.$childDest->category_name.'&s='.$childDest->category_name.'&ref=syd')}}">{{$childDest->category_name}}</a></li>
                                        @endforeach
                                        @endif
                                    </ul>
                                </div>
            ...
            <div class="book-now-page date-page" <?php if(isset($_GET['ref']) && $_GET['ref']=='sbd'){ echo 'style="width:100%;"';}?>>
                <div class="book-now-page-content open-date-html">
                    ...
                    <div class="headings">
                        <h2>Emporium Yachts is your ideal, vogue vacation planner!</h2>
