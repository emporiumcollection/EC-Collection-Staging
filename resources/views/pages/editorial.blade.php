                ...
                <aside class="site-aside">
                    <div class="contact-aside">
                        <ul class="contact-aside-list">
                            ...
                            <li class="contact-list-item contact-email"><a href="mailto: reservations@emporium-voyage.com"><i class="fa fa-envelope asideIclass" aria-hidden="true"></i> reservations@emporium-voyage.com</a></li>
                        </ul>
                    </div>
                </aside>
                ...
                <div class="row">
                    ...
                    <div class="m_slider editorial_m_slider">
                        ...
                        <ul>
                            ...
                            {{--*/ $thactualsize = getimagesize($propertyDetail['propimage_thumbpath_dir'].$propimg->file_name); /*--}}
