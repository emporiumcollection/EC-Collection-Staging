					...
					@if(array_key_exists('1',$relatedproperties))
						<div class="hotel-next-previous-outer">
							<div class="next-hotel-btn previous-next-pannel"> 
                                                            <a href="{{URL::to($relatedproperties[1]->property_slug)}}"><img class="img-responsive next-hotel-arrow" src="{{ asset('sximo/assets/images/editorial-right-arrow.png')}}" alt=""/></a>
