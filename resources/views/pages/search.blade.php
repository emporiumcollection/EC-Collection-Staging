            ...
            <header>
                ...
                <div class="region region-sidebar-first sidebar">
                    <div class="region-inner clearfix">
                        <div id="block-ledunfly-menu-link"
                             class="block block-ledunfly no-title odd first block-count-4 block-region-sidebar-first block-menu-link">
                        ...
                        <div id="block-system-main-menu"
                             class="block block-system block-menu no-title odd block-count-6 block-region-sidebar-first block-main-menu"
                             role="navigation">
                            <div class="block-inner clearfix">
                ...
                <div class="col-md-10 col-sm-9 FloatFilter pull-right">
                    <div class="row">
                        ...
                        <section class="book-form-top-bar hidden-xs hidden-sm">
                            <div>
                                <div class="booking-form-bar-top">
                                    <form autocomplete="off" method="get" id="searchform-navbar"
                                          class="searchform-navbar top-bar-search-form-align"
                                          action="{{URL::to('search')}}">
                                        <div class="col-md-3">
                                            <div class="row">
                                                <div class="form-group would-like-input top-bar-search padding-right-12">
                                                    <input class="form-control ai-custom-deafault-style bh-search-input typeahead search-box searchbox_landing"
                                                           name="s" id="search-navbar"
                                                           placeholder="Enter Your Hotel or Destination" type="text"
                                                           required="required">
                                                </div>
                                            </div>
                                        </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="row">
                                                            <div class="form-group padding-right-12">
                                                                <input id="top-bar-search-booking-form-arrive"
                                                                       class="form-control ai-custom-deafault-style"
                                                                       name="arrive" type="text" placeholder="Arriving">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="row">
                                                            <div class="form-group padding-right-12">
                                                                <input id="top-bar-search-booking-form-destination"
                                                                       class="form-control ai-custom-deafault-style"
                                                    ...
                                                    <div class="dropdown top-search-members-list">
                                                        <div class="top-search-members-inner-align">
                                                            ...
                                                            <ul class="members-drop-list" style="display: none;">
                                                                <li>
                                                                    <label>Adult</label>
                                                                    <input id="adult-input-value" name="adult"
                                                                           class="input-right" value="2" min="1"
                                                                           max="10" type="number">
                                                                </li>
                                                                <li>
                                                                    <label>Children</label>
                                                                    <input id="childerns-input-value" name="childs"
                                                                           class="input-right" value="0" min="0"
                                                                           max="10" type="number">
                                                                </li>
                                                            </ul>
                                                        </div>
                                                    ...
                                                    <select name='currencyOption' class="form-control">
                                                        ...
                                                        @foreach($currencyList as $currencyCode => $currencyName)
                                                            ...
                                                            <option value="{{ $currencyCode }}"
                                                                    title="{{ $currencyName }}">{{ $currencyName }}
                                                            </option>
                                        ...
                                        <div class="col-md-1">
                                            <a data-popup-id="login-forms-popup" href="#"
                                               class="video-popup-btn login_popup show-login-forms-btn"><i
                                                        class="fa fa-lock detailfaLock" aria-hidden="true"></i></a>
                                            <a data-popup-id="ev-primary-navigation" href="#" class="video-popup-btn">
                                ...
                                <aside class="site-aside">
                                    <div class="contact-aside">
                                        <ul class="contact-aside-list">
                                            <li class="contact-list-item contact-phone"><a href="tel:+1 934 451 1317"><i
                                                            class="fa fa-phone asideIclass" aria-hidden="true"></i> +1
                                                    934 451 1317</a></li>
                                            <li class="contact-list-item contact-email"><a
                                                        href="mailto: reservations@emporium-voyage.com"><i
                                                            class="fa fa-envelope asideIclass" aria-hidden="true"></i>
                                                    reservations@emporium-voyage.com</a></li>
                                        </ul>
                                    </div>
                                </aside>
                                            ...
                                            <div class="row">
                                                <div id="top-bar-search-booking-form-res">
                                                    <div class="col-md-6">
                                                        <div class="row">
                                                            <div class="form-group padding-right-12">
                                                                <input id="top-bar-search-booking-form-arrive-res"
                                                                       class="form-control ai-custom-deafault-style"
                                                                       name="arrivel" type="text" placeholder="Arrival">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="row">
                                                            <div class="form-group padding-right-12">
                                                                <input id="top-bar-search-booking-form-destination-res"
                                                                       class="form-control ai-custom-deafault-style"
                                                                       name="destinationation" type="text"
                                                    ...
                                                    <div class="dropdown top-search-members-list">
                                                        <div class="top-search-members-inner-align">
                                                            ...
                                                            <ul class="members-drop-list" style="display: none;">
                                                                <li>
                                                                    <label>Adult</label>
                                                                    <input id="adult-input-value-res" name="adult"
                                                                           class="input-right" value="2" min="1"
                                                                           max="10" type="number">
                                                                </li>
                                                                <li>
                                                                    <label>Children</label>
                                                                    <input id="childerns-input-value-res" name="childs"
                                                                           class="input-right" value="0" min="0"
                                                                           max="10" type="number">
                                                                </li>
                                                            </ul>
                        ...
                        <div class="grid-page-category-slider-container">
                            @if(!empty($categoryslider))
                                <div class="bh-slideshow-thumbnail-split hidden-xs hidden-sm"
                                     data-uk-slideshow="{animation: 'slice-up', autoplay: true}"
                                     style="margin-bottom:20px;margin-top:64px;">
                                    <ul style="" class="uk-slideshow uk-overlay-active">
                                        @foreach($categoryslider as $slides)
                                            <li class="ai-uk-animation" style=""
                                                @if($categoryslider[0]==$slides) class="uk-active"
                                                @endif aria-hidden="true">
                                                @if($slides->slide_type == 'Image')
                                                    <div style="background-image: url({{ URL::to('uploads/slider_images/'.$slides->slider_img)}});"
                                                         class="uk-cover-background uk-position-cover"></div>
                                                @else
                                                    <div class="uk-cover-background uk-position-cover">
                                                        <iframe class="video-bg"
                                                                src="https://www.youtube.com/embed/{{$slides->slider_video}}?playlist={{$slides->slider_video}}&iv_load_policy=3&enablejsapi=1&disablekb=1&autoplay=1&controls=0&showinfo=0&rel=0&loop=1&wmode=transparent"
                                                                frameborder="0"
                                                ...
                                                <div class="bh-slideshow-overlay uk-overlay-panel uk-overlay-fade uk-flex uk-flex-middle uk-flex-center">
                                                    <div>
                                                        <ul class="bh-slideshow-overlay-meta uk-subnav uk-subnav-line">
                                                            <li>
                                                                <span><a href="#"
                                                                         rel="category tag">{{$slides->slider_category}}</a></span>
                                                            </li>
                                                        </ul>
                                                        ...
                                                        @if($slides->slider_link != '#')
                                                            <a class="uk-margin-top uk-button uk-button-primary"
                                                               onclick="return !window.open(this.href, '{{ ((strpos($slides->slider_link, 'http://') || strpos($slides->slider_link, 'https://')) === false) ? $slides->slider_link : 'http://'.$slides->slider_link }}', 'width=900,height=500,left=100, top=100, scrollbars, resizable')"
                                                               href="{{ ((strpos($slides->slider_link, 'http://') || strpos($slides->slider_link, 'https://')) === false) ? $slides->slider_link : 'http://'.$slides->slider_link }}"
                                                               title="Do it yourself">Discover <i
                                                                        class="zmdi zmdi-long-arrow-right uk-margin-small-left"></i></a>
                                                        @endif
                                                    </div>
                                                </div>
                                                <div class="bh-slideshow-thumbnail-split-preview uk-overlay-panel uk-overlay-right uk-overlay-background uk-overlay-fade uk-width-2-5 uk-width-xxlarge-1-3 uk-flex uk-flex-middle uk-flex-center uk-visible-large">
                                                    <div style="width: 80%;">
                                                        ...
                                                        <div class="bh-slideshow-thumbnail-split-preview-content scrollbar1"
                                                             id="style-3">{{ $slides->slider_description }}</div>
                                                    @if(strlen($slides->slider_description)>118)
                                                        ...
                                                        @if($slides->slider_link != '#')
                                                            <a class="uk-margin-top uk-button uk-button-primary"
                                                               onclick="return !window.open(this.href, '{{ ((strpos($slides->slider_link, 'http://') || strpos($slides->slider_link, 'https://')) === false) ? $slides->slider_link : 'http://'.$slides->slider_link }}', 'width=900,height=500,left=100, top=100, scrollbars, resizable')"
                                                               href="{{ ((strpos($slides->slider_link, 'http://') || strpos($slides->slider_link, 'https://')) === false) ? $slides->slider_link : 'http://'.$slides->slider_link }}">Discover
                                                                <i class="zmdi zmdi-long-arrow-right uk-margin-small-left"></i></a>
                                                        @endif
                                                    </div>
                                                    <a href="javascript:void(0);"
                                                       class="bh-slideshow-slidenav uk-slidenav uk-slidenav-previous"
                                                       data-uk-slideshow-item="previous"></a>
                                                    <a href="javascript:void(0);"
                                                       class="bh-slideshow-slidenav uk-slidenav uk-slidenav-next"
                        ...
                        <div class="col-md-12">
                            <div class="col-md-4 col-xs-4">
                                <a href="#"><img class="img-responsive TopbarSearch hidden-md hidden-lg"
                                                 src="{{asset('sximo/assets/images/hotel.png')}}" alt=""></a>
                            </div>
                            <div class="col-md-4 col-xs-4">
                                <a data-popup-id="login-forms-popup" href="#"
                                   class="video-popup-btn login_popup show-login-forms-btn hidden-md hidden-lg"><i
                                            class="fa fa-lock detailfaLock" aria-hidden="true"></i></a>
                            </div>
                            <div class="col-md-4 col-xs-4">
                                <a data-popup-id="ev-primary-navigation" href="#"
                                   class="video-popup-btn hidden-md hidden-lg">
                                    <!--<i class="fa fa-bars hamburgMenu" aria-hidden="true"></i>-->
                                    <div class="block-content content">
                                        <span></span>
                                        <span> </span>
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12 ">
                            <div class="row"
                                 style="{{ ($total_record==0)?'padding:100px 0 0;text-align: center;':'padding:10px 0 0;text-align: center;'}}">
                            ...
                            <div id="cityfilters">
                                ...
                                @if(!empty($cities))
                                    ...
                                    <div class="row"
                                         style="padding-bottom: 8px;background: #f0f0f0;padding-top: 8px;margin-bottom: 15px; margin-left: 0; margin-right: 0;">
                                                            ...
                                                            <div class="wrapperforliineedforlightboxremoval">
                                                                <div class="cat_product_medium1">
                                                                    <div class="ai-grid-page-node-pic-box pictureBox gridPicture">
                                                                        <a title="{{$reultsgridAds[$ads_node]->adv_title}}"
                                                                           class="picture_link-"
                                                                           href="{{ (strpos($reultsgridAds[$ads_node]->adv_link, 'http://') !== false) ? $reultsgridAds[$ads_node]->adv_link : 'http://'.$reultsgridAds[$ads_node]->adv_link }}">
                                                                            <h2 style="position:absolute; color:#fff;padding-left: 20px;">
                                                                                Advertiser</h2>
                                                                            <img alt="{{$reultsgridAds[$ads_node]->adv_title}}"
                                                                                 src="{{URL::to('uploads/users/advertisement/'.$reultsgridAds[$ads_node]->adv_img)}}"
                                                                                 class="img-responsive"
                                                                                 style="border: 2px solid #D3D6D2;padding: 3px 1px 3px 0px;">
                                                                        </a>
                                                                    </div>
                                                                    <div class="listDetails">
                                                                        <div class="photographBox">
                                                                            <h2>
                                                                                <a title="{{$reultsgridAds[$ads_node]->adv_title}}"
                                                                                   class="photograph FltLft ai-filtreted-hotel-name"
                                                                                   href="{{ (strpos($reultsgridAds[$ads_node]->adv_link, 'http://') !== false) ? $reultsgridAds[$ads_node]->adv_link : 'http://'.$reultsgridAds[$ads_node]->adv_link }}">
                                                        ...
                                                        <div class="cat_product_medium1">
                                                            <div class="ai-grid-page-node-pic-box pictureBox gridPicture grid-box-main">
                                                                ...
                                                                @if(!empty($images) && count($images)>0)
                                                                    ...
                                                                    @if($props->editor_choice_property=='1')
                                                                        <img alt="editor_choice_property"
                                                                             class="propovericons"
                                                                             src="{{URL::to('sximo/images/editors-choice.png')}}">
                                                                    @elseif($props->feature_property=='1')
                                                                        <img alt="editor_choice_property"
                                                                             class="propovericons"
                                                                             src="{{URL::to('sximo/images/featured-property.png')}}">
                                                                    @endif

                                                                    <a title="{{$props->property_name}}"
                                                                       class="picture_link-"
                                                                       href="{{URL::to($props->property_slug)}}"
                                                                       rel="{{$props->id}}">
                                                                        <div class="overlay-text-frezeed">
                                                                            <h2 class="yacts-tittle-text">{{ $props->property_name}}</h2>
                                                                            <p class="yacths-des-text yacths-des-text-align">
                                                                                <span>&euro;<?php echo $props->price; ?> </span>|<span>37.7mm</span>|<span>10 Guests</span>
                                                                            </p>
                                                                        </div>
                                                                        <div class="overlay-text hotel-overlay-text">
                                                                            <h2 class="yacts-tittle-text">{{ $props->property_name}}</h2>
                                                                            <p class="yacths-des-text yacths-des-text-align">
                                                                                <span>From &euro;{{ $props->price}} </span>
                                                                                <span>      {{(isset($props->category_name))? '| '.$props->category_name : ''}}</span>
                                                                            </p>
                                                                        </div>
                                                                        <div class="overlay-text yacts-overlay-text">
                                                                            <h2 class="yacts-tittle-text">{{ $props->property_name }}</h2>
                                                                            <p class="yacths-des-text yacths-des-text-align">
                                                                                <span>&euro;{{ $props->price}} </span>|<span>37.7mm</span>|<span>10 Guests</span>
                                                                            </p>
                                                                            <p class="yacths-des-text">2015H</p>
                                                                        </div>
                                                                        <img alt="{{ $propsImageFileName }}"
                                                                             src="{{$images[0]->imgsrc.$propsImageFileName}}"
                                                                             class="img-responsive">
                                                                    </a>
                                                                @else
                                                                    <a class="picture_link detail_view-"
                                                                       rel="{{$props->id}}"
                                                                       href="{{URL::to($props->property_slug)}}">
                                                                        <div class="overlay-text-frezeed">
                                                                            <h2 class="yacts-tittle-text">{{ $props->property_name}}</h2>
                                                                            <p class="yacths-des-text yacths-des-text-align">
                                                                                <span>&euro;500 </span>|<span>37.7mm</span>|<span>10 Guests</span>
                                                                            </p>
                                                                        </div>
                                                                        <div class="overlay-text hotel-overlay-text">
                                                                            <h2 class="yacts-tittle-text">{{ $props->property_name }}</h2>
                                                                            <p class="yacths-des-text yacths-des-text-align">
                                                                                <span>From &euro;{{ $props->price}} </span>|<span>New York</span>
                                                                            </p>
                                                                        </div>
                                                                        <div class="overlay-text yacts-overlay-text">
                                                                            <h2 class="yacts-tittle-text">{{ $props->property_name }}</h2>
                                                                        ...
                                                                        <img class="img-responsive"
                                                                             src="{{URL::to('sximo/assets/images/img-1.jpg')}}"
                                                                             alt="">
                                                                    </a>
                                                                @endif
                                                            </div>
                                                            <div class="listDetails">
                                                                <div class="photographBox ai-grid-tiitles">
                                                                    <h2>
                                                                        ...
                                                                        <!--<a class="carticon" href="javascript:void(0)" onclick="submitgridbookform('{{$props->property_slug}}#*{{$props->id}}');"><i class="fa fa-shopping-cart colorGrey" aria-hidden="true" title="book this hotel"></i></a>-->
                                                                            <a class="carticon"
                                                                               href="{{URL::to($props->property_slug)}}"><i
                                                                                        class="fa fa-shopping-cart colorGrey"
                                                                                        aria-hidden="true"
                                                                                        title="book this hotel"></i></a>
                                                                    </span>
                                                                    </h2>
                                                                ...
                                                                <div class="entire_story MrgTop5 ai-view-hotels-tittle">
                                                                    <a class="textButton arrowButton detail_view MrgTop5"
                                                                       rel="{{$props->id}}" href="#">
                                                                        Quick View
                                                                    </a>

                                                                    <a class="textButton arrowButton MrgTop5"
                                                                       rel="{{$props->id}}"
                                                                       href="{{URL::to($props->property_slug)}}">
                                                                        Detail View
                                                                    </a>
...
<input class="ai-arrive-date-filter"
       value="<?php echo (isset($_REQUEST['arrive'])) ? date('d-m-Y', strtotime($_REQUEST['arrive'])) : date("d-m-Y"); ?>"
       type="hidden"/>
<input class="ai-depart-date-filter"
       value="<?php echo (isset($_REQUEST['destination'])) ? date('d-m-Y', strtotime($_REQUEST['destination'])) : date("d-m-Y", strtotime("+ 1 day")); ?>"
       type="hidden"/>
        ...
        <div class="filter-grid-page-side-bar">
            <div class="filters-gird-page-side-bar-filter-align">
                <div class="design-locations-logo">
                    <a href="{{URL::to('')}}"> <img class="img-responsive"
                                                    src="{{ asset('sximo/assets/images/design-location-logo.png')}}"
                                                    alt=""></a>

                </div>
                <div class="design-locations-logo filters-page-serch-bar-align">
                    <form autocomplete="off" method="get" id="searchform-navbar"
                          class="searchform-navbar ai-ajax-searchform-navbar" action="{{URL::to('search')}}">
                        <input class="bh-search-input typeahead search-navbar ai-ajax-search-input" name="s"
                               id="search-navbar" placeholder="SEARCH" type="text">
                        <input class="hidden" type="submit" value="Submit"/>
                    </form>
                </div>
                <div class="panel-group" id="accordion">
                    <div class="panel panel-default custom-post-panel">
                        <a data-toggle="collapse" data-parent="#accordion" href="#filter-by-price"
                           class="heading-stying collapsed">
                                ...
                                <div class="dl-filter">
                                    <div class="filter-by-price">
                                        ...
                                        <p>
                                            ...
                                            <input class="friltered-price" type="text" id="amount"
                    ...
                    <div class="panel panel-default custom-post-panel">
                        <a data-toggle="collapse" data-parent="#accordion" href="#book-your-destination"
                           class="heading-stying <?php echo ($segment_1=='search' && isset($_REQUEST['arrive']))? '' : 'collapsed'; ?>">
                            <div class="panel-heading custom-heading">
                                Change My Dates
                            </div>
                        </a>
                        <div id="book-your-destination"
                             class="panel-collapse collapse <?php echo ($segment_1=='search' && isset($_REQUEST['arrive']))? 'in' : ''; ?>">
                            <div class="panel-body custom-panel-body">
                                <div class="dl-filter">
                                    <div>
                                        <form class="filter-menu-booking ai-date-filters"
                                              action="{{url::to('search')}}">
                                            <input name="s"
                                                   value="<?php echo (isset($_REQUEST['s'])) ? $_REQUEST['s'] : '' ?>"
                                                   type="hidden"/>
                                            <input name="adult"
                                                   value="<?php echo (isset($_REQUEST['adult'])) ? $_REQUEST['adult'] : '1' ?>"
                                                   type="hidden"/>
                                            <input name="childs"
                                                   value="<?php echo (isset($_REQUEST['childs'])) ? $_REQUEST['childs'] : '0' ?>"
                                                   type="hidden"/>
                                            <div class="form-group post-filter-inputs">
                                                <label>Arrive</label>
                                                <input id="filter-date-mobile" class="ai-arrive-date"
                                            ...
                                            <div class="form-group post-filter-inputs">
                                                <label>Depart</label>
                                                <input id="filter-date-mobile-departure" class="ai-depart-date"
                                                       data-format="DD-MM-YYYY" data-template="DD MMM YYYY"
                                                       name="destination"
                                                       value="<?php echo (isset($_REQUEST['destination'])) ? date('d-m-Y', strtotime($_REQUEST['destination'])) : date("d-m-Y", strtotime("+ 1 day")); ?>"
                                                       type="text">
                    ...
                    <div class="panel panel-default custom-post-panel">
                        <a data-toggle="collapse" data-parent="#accordion" href="#collapse1"
                           class="heading-stying <?php echo ($segment_1=='luxury_experience' && $continent == '')? '' : 'collapsed'; ?>">
                            <div class="panel-heading custom-heading">
                                Experience
                            </div>
                        </a>
                        <div id="collapse1"
                             class="panel-collapse <?php echo ($segment_1=='luxury_experience' && $continent == '')? 'in' : ''; ?> <?php echo (isset($_REQUEST['s']) && in_array($_REQUEST['s'], array('Beach Hotels', 'Green Properties', 'Go Urban Hotels', 'Infinity Pools', 'Spa and Wellness Hotels', 'Mountain Ski Resorts', 'Yoga Hotels', 'Culinary Delights', 'Family Friendly', 'Unusual Adventure Hotels')))? 'in' : ''; ?> collapse">
                            <div class="panel-body custom-panel-body">
                                <div class="dl-filter">
                                    <form>
                                        ...
                                        @if(!empty($experiences))
                                            @foreach($experiences as $experience)
                                                <div class="form-group post-filter-inputs <?php echo (str_replace('_', ' ', $cat) == $experience->category_name)? 'active' : ''; ?>">
                                                    <label><a onclick="$('#collapse1 .post-filter-inputs').removeClass('active');$(this).parents('.post-filter-inputs').addClass('active');experience_property_filter('{{$experience->category_name}}');"
                                                              href="javascript:void(0);">{{$experience->category_custom_title}}</a></label>
                                                </div>
                                        @endforeach
                                    @endif
                                    <!--<div class="form-group post-filter-inputs">
                ...
                <div class="filter-footer">
                    ...
                    <div class="clear-all-filters"><a onclick="javascript:clear_all_filters();"
                                                      href="javascript:void(0);"><i class="fa fa-repeat"
                ...
                <section class="regular slider">
                    ...
                    <div class="slick-cstm-width">
                        <a href="{{ (strpos($slides->adv_link, 'http://') !== false) ? $slides->adv_link : 'http://'.$slides->adv_link }}"><img
                                    src="{{URL::to('uploads/users/advertisement/'.$slides->adv_img)}}"></a>
                    </div>
                    @endforeach
                    @endif
                </section>
...
<div id="frontpage-layer-bj-detail" class="frontpage-layer-bj">
    <div id="frontpage-layer-bj-header-wrapper">
        <div id="frontpage-layer-bj-header">
            <a href="#" id="frontpage-layer-bj-header-logo"> <img alt=""
                                                                  src="{{ asset('sximo/assets/images/design-location-logo.png')}}"
                                                                  class="img-responsive yachts-pop-up-logo"></a>
        </div>
