            ...
            <aside class="site-aside">
                <div class="contact-aside">
                    <ul class="contact-aside-list">
                        ...
                        <li class="contact-list-item contact-email"><a href="mailto: reservation@emporium-voyage.com"><i class="fa fa-envelope asideIclass" aria-hidden="true"></i> reservations@emporium-voyage.com</a></li>
                    </ul>
                </div>
            </aside>
                                                        ...
                                                        <div class="slider-sec-side-text-bg">
                                                            <div class="slider-side-sec-alignment">
                                                                ...
                                                                <div class="slider-side-description-text">
                                                                    {!! (strlen($package->package_description) > 300) ? substr(nl2br($package->package_description),0,300).'...':nl2br($package->package_description) !!}
                                                                </div>
                                                            </div>
                                                            <div>
