                                                ...
                                                <div class="wrapperforliineedforlightboxremoval">
                                                    <div class="cat_product_medium1">
                                                        <div class="pictureBox gridPicture">
                                                            ...
                                                            <a title="{{$props['image']->file_name}}" class="picture_link-" href="{{URL::to('our-collection/'.$props['data']->property_slug)}}">
                                                        ...
                                                        <div class="listDetails">
                                                            <div class="photographBox">
                                                                <h2>
                                                                    <a title="{{$props['data']->property_name}}" class="photograph FltLft ai-filtreted-hotel-name" rel="{{$props['data']->id}}" href="{{URL::to('our-collection/'.$props['data']->property_slug)}}">
