<section data-selector="section" id="text-2col2">
	<div class="container">
		...
		<h1 data-selector="h3" class="title bjproduct-title">Information</h1>
	...
	<section id="benefits-grid-images-left">
		<div class="container">
			<div class="row no-dev">
				@if(!empty($newspage_cat_services))
					{{--*/ $nw = 0 /*--}}
					@foreach($newspage_cat_services as $news)
							...
							<div class="col-sm-6 MarBot10">
								<ul class="item-list2">
									<li>
										...
										{{ (\Session::get('newlang')=='English') ? strip_tags($news->description_pos_1_eng) : strip_tags($news->description_pos_1) }}
										</p>
