	...
	$(document).on('click','.detail_view',function(){
		...
		$.ajax({
		  ...
		  success: function(data){
			...
			imagesPro+='<textarea class="ai-textarea-width" name="use" rows="5" cols="20" placeholder="Use" required="required"></textarea>';
			imagesPro+='</div>';
			imagesPro+='</div>';
			...
			imagesPro+='<div class="col-md-12">';
			imagesPro+='<div class="row">';
			imagesPro+='<textarea class="ai-textarea-width" name="notes" rows="5" cols="20" placeholder="Notes, Deadlines, Extras..."></textarea>';
			imagesPro+='</div>';
			imagesPro+='</div>';
			imagesPro+='</div>';
			imagesPro+='<div class="row MarBot10">';
