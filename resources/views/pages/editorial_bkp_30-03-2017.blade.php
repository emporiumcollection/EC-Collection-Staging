                                    ...
                                    <div class="col-md-6">
                                        <div class="hotel-block-two-right-sec-align">
                                            ...
                                            <div class="hotel-block-two-btn-right">
                                                <a href="#">Learn More</a>
                                                <a href="#"  rel="" class="open-show_more-page hotel-btn">Show More</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
												...
												<div class="info1">
													...
													<div class="hotel-detail-slider-price-and-show-more">
														...
														<div class="hotel-slider-price">
															{{($currency->content!='') ? $currency->content : '$'}} {{($type->price!='') ? $type->price : '500'}}
														</div>
													</div>
													<div class="clearfix"></div>
													<div class="viewmore">
...
//                        $('.rmimgp').html('<img class="img-responsive" src="' + rimg + '" alt="' + data.roomimgs.file_name + '" />');
                        ...
                        imagesPro += (data.typedata.price!='') ? data.typedata.price : '500';
                        imagesPro += '</div">';
                        imagesPro += '</div>';
