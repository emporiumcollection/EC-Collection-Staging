            ...
            <aside class="site-aside">
                <div class="contact-aside">
                    <ul class="contact-aside-list">
                        ...
                        <li class="contact-list-item contact-email"><a href="mailto: reservations@emporium-voyage.com"><i class="fa fa-envelope asideIclass" aria-hidden="true"></i> riaan@emporium-voyage.com</a></li>
                    </ul>
                </div>
            </aside>
...
<!--                                <li>
                ...
                <div class="col-md-10 no-padding ResponsiveInpressionMain">
                   @if(!empty($pageslider))
