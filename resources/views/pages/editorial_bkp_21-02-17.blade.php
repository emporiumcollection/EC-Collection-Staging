                                    ...
                                    <div class="col-md-6">
                                        <div style="height: 370.688px; opacity: 1; width: 100%;" class="principale1 prc">
                                            <div style="height: 370.688px;" class="foto2" rel="clio">
                                                <img style="height: 370.688px; width: 659px;" src="{{ asset('sximo/assets/images/clio4.jpg')}}" rel="2" alt="Annie Collection">
                                            </div>
                                    ...
                                    <div class="col-md-6">
                                        <div style="height: 370.688px; opacity: 1; width: 100%;" class="principale2 prc">
                                            <div style="height: 370.688px;" class="foto2" rel="erato">
                                                <img style="height: 370.688px; width: 659px;" src="{{ asset('sximo/assets/images/clio1.jpg')}}" rel="2" alt="Annie Collection">
                                            </div>
                                            <div style="height: 370.688px; width: 100%;" class="foto1" rel="erato">
                                                <img style="height: 370.688px; width: 659px;" src="{{ asset('sximo/assets/images/clio4.jpg')}}" rel="1" alt="Annie Collection">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
