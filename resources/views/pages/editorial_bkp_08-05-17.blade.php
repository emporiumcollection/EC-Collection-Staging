    ...
    <head>
        ...
        <style>
            ...
            .restaurant-sec-main-bg-align {
                background-image: url("{{ $propertyDetail['propimage'][0]->imgsrc.$propertyDetail['propimage'][0]->file_name }}");
            }
                                    ...
                                    <div class="disply-left-right-align">
                                        <div class="col-md-6 disply-left-right-inner">
                                            <div class="hotel-block-two-left-sec-align">
                                                ...
                                                <p>
                                                    {{print_r(nl2br($propertyDetail['data']->detail_section1_description_box1))}}
                                                </p>
                                            </div>
                                        </div>
                                        <div class="col-md-6 disply-left-right-inner">
                                            <div class="hotel-block-two-right-sec-align">
                                                <h2>{{$propertyDetail['data']->detail_section1_title}}</h2>
                                                <p>
                                                    {{print_r(nl2br($propertyDetail['data']->detail_section1_description_box2))}}
                                                </p>
                                    ...
                                    <div class="col-md-12 col-sm-12 disply-left-right-align">
                                        <div class="col-md-6 col-sm-6 disply-left-right-inner hotels-des-left-side">
                                            <div class="hotels-detail-heading-text">
                                                <p>{{print_r(nl2br($propertyDetail['data']->detail_section2_title))}}</p>
                                            </div>
                                            <div class="hotels-detail-description-text">
                                                <p class="hotel-description-text">
                                                    {{print_r(nl2br($propertyDetail['data']->detail_section2_description_box1))}}
                                                </p>
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-sm-6 disply-left-right-inner hotels-showcase-right-side">
                                            <div class="hotels-image-showcase-des-text">
                                                <p class="hotel-description-text">
                                                    {{print_r(nl2br($propertyDetail['data']->detail_section2_description_box2))}}
                                                    <br>
                                                        ...
                                                        <div class="col-md-6 col-sm-6">
                                                            <div class="row">
                                                                <div class="view-gallery-pannel-align">
                                                                    <span class="view-gallery-border-left"></span>
                                                                    <a href="#" class="detail_view gallerysty bar-view-gallery" rel="{{$propertyDetail['data']->id}}" rel2="Bar Gallery Images">View Gallery</a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-6 col-sm-6">
                                                        <div class="row">
                                                            ...
                                                            <div class="spa-sec-view-gallery">
                                                                <span class="view-gallery-border-left"></span>
                                                                <a href="#" class="detail_view gallerysty bar-view-gallery" rel="" rel2="">View Gallery</a>
                                                            </div>
                                                            <div class="clearfix"></div>
                    ...
                    <div class="popup-content res-gallery-sec-padding">
                        <div class="image-slider-container">
                            ...
                            <ul class="image-slider post-page-sideshow">
                                ...
                                ?>
    <!--                            <li class="active"><img class="img-responsive" src="{{$propertyDetail['roomimgs'][$propertyDetail['typedata'][$key]->id][0]->imgsrc.$propertyDetail['roomimgs'][$propertyDetail['typedata'][$key]->id][0]->file_name}}" alt=""/></li>
                                <li><img class="img-responsive" src="{{ $propimg->imgsrc.$propimg->file_name }}" alt=""/></li>
                                <li><img class="img-responsive" src="{{URL::to('uploads/properties_subtab_imgs/'.$propertyDetail['data']->architecture_image)}}" alt=""/></li>-->
                            </ul>
