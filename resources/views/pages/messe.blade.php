...
<section data-selector="section" id="text-2col2">
	<div class="container">
		...
		<h1 data-selector="h3" class="title bjproduct-title">{{\Lang::get('core.menu_frontend_messe')}}</h1>
...
<div class="container gg news-custom">
	@if(!empty($newspage_cat_Messe))
		<section id="benefits-grid-images-left">
			<div class="container">
				<div class="row no-dev">
				
					{{--*/ $nw = 0 /*--}}
					@foreach($newspage_cat_Messe as $news)
		...
		<section data-selector="section" id="text-2col">
			<div class="container2">
				<div class="row">
					<h3 class="poat-heading2">{{ (\Session::get('newlang')=='English') ? $newspage_cat_Messe[0]->cat_title_eng : $newspage_cat_Messe[0]->cat_title}}</h1>
					<div>{!! (\Session::get('newlang')=='English') ? $newspage_cat_Messe[0]->cat_description_eng : $newspage_cat_Messe[0]->cat_description !!}</div>
				</div>
			</div>
		</section>
