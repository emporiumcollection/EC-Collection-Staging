                                                ...
                                                <div class="col-md-4">
                                                    <div class="row">
                                                        <div class="form-group would-like-input top-bar-search padding-right-12">
                                                            ...
                                                            <input  class="form-control ai-custom-deafault-style bh-search-input typeahead search-box" name="s" id="search-navbar" placeholder="Enter Your Hotel or Destination" type="text">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                                ...
                                                                <div class="top-search-members-inner-align">
                                                                    ...
                                                                    <ul class="members-drop-list" style="display: none;">
                                                                        ...
                                                                        <li>
                                                                            ...
                                                                            <input id="childerns-input-value" name="childs" class="input-right" value="0" max="5" type="number">
                                                                        </li>
                                                                    </ul>
                                                                </div>
                                                            </div>
                                ...
                                <div class="right-menus right-menu-sidebar">
                                    ...
                                    <div class="side-bar-why-book-with-us">
                                        ...
                                        <ul class="side-bar-book-with-us-list">
                                            <li>
                                                <h3>Handpicked Selaction of Hotels.</h3>
                                            ...
                                            <li>
                                                ...
                                                <p>Ezxclisive community invitations</p>
                                            </li>
                                            <li>
                                                <h3>Free WiFi</h3>
