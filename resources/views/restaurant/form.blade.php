		...
		<div class="sbox animated fadeInRight">
			...
			<div class="sbox-content">
                ...
                <ul class="nav nav-tabs">
                    <li class="active"><a href="#RestaurantDetails" data-toggle="tab">Restaurant Details</a></li>
                    @if($id)
                ...
                <div class="tab-content">
                    <div class="tab-pane m-t active" id="RestaurantDetails">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane m-t active" id="SubtabRestaurantDetails">
                				...
                				<div class="col-md-12">
                					...
                					<div class="form-group  " >
                						<label for="Url" class=" control-label col-md-4 text-left"> Accolades </label>
                						<div class="col-md-6">
                							{!! Form::textarea('url', $row['url'],array('class'=>'form-control', 'placeholder'=>'',   )) !!}
                						</div>
                						<div class="col-md-2">
                ...
                <div class="tab-pane m-t" id="GalleryImages">
					...
					<form id="fileuploadgalleryimages" class="fileupload" action="{{URL::to('resturant_images_uploads')}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="tab-pane m-t" id="SliderImages">
                    <!-- The file upload form used as target for the file upload widget -->
					<form id="fileuploadsliderimages" class="fileupload" action="{{URL::to('resturant_images_uploads')}}" method="POST" enctype="multipart/form-data">
						<input type="hidden" name="propId" value="{{$row['id']}}" />
                ...
                <div class="tab-pane m-t" id="Menu">
                    <!-- The file upload form used as target for the file upload widget -->
					<form id="fileuploadmenu" class="fileupload" action="{{URL::to('resturant_images_uploads')}}" method="POST" enctype="multipart/form-data">
						<input type="hidden" name="propId" value="{{$row['id']}}" />
									...
									@foreach($res_menu as $img)
										<tr class="template-download fade in row{{$img->id}}">
											...
											<td>
                                                ...
                                                <button type="button" class="btn btn-danger" onclick="add_restaurant_menu_title({{$img->id}});" >
													<i class="glyphicon glyphicon-plus"></i>
...
<script> var baseUrl = "{{URL::to('resturant_images_uploads')}}"; </script>
...
<script>
    ...
    function add_restaurant_menu_title(mid){
        
        $.ajax({
            url: "{{ URL::to('restaurant/menutitle')}}",
            type: "get",
            data: {mid:mid},
            dataType: "json",
            success: function(data){
	...
	function delete_restaurant_image(imgID)
	{
		if(imgID!='' && imgID>0)
		{
			...
			{
				$.ajax({
					url: "{{ URL::to('delete_restaurant_image')}}",
					type: "post",
					data: "img_id="+imgID,
					dataType: "json",
					success: function(data){
	...
	function delete_rest_selected_imgs(cls)
	{
		var conf = confirm("Are you sure? you want to delete this record!");
		if(conf==true)
		{
			...
			$.ajax({
			  url: "{{ URL::to('delete_rest_selected_image')}}",
			  type: "post",
			  data: "items=" + sList,
			  dataType: "json",
			  success: function(data){
