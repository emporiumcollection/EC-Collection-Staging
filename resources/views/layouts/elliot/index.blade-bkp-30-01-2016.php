...
<html lang="en">
  ...
  <body data-spy="scroll" data-target=".navMenuCollapse">
	<div id="wrap">
		...
		<div id="navbar">    
		  <nav class="navbar navbar-default navbar-static-top bg-color1 dark-bg" role="navigation">
			<div class="container"> 
				<div class=" nav-menu">
					<div class="navbar-header">
					  ...
					  <a class="navbar-brand goto" href="{{URL::to('')}}"><img src="{{ asset('sximo/images/janua-logo.svg')}}" alt="Your logo" height="25"></a>
					</div>
					...
					<div class="modal-dialog" role="document">
					  ...
					  <div class="modal-content">
						<div class="modal-header">
						  ...
						  <h2><img src="{{ asset('sximo/images/janua-logo.svg')}}" alt="Your logo" height="25"> <span>Account</span></h2>
