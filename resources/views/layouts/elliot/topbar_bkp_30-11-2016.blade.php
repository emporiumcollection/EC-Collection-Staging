...
{{--*/ $menus = SiteHelpers::menus('top') /*--}}
 	 <ul class="nav navbar-nav">
		...
		@endforeach
		<li data-selector="nav li"><button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal"><b>Membership Subscription</b></button></li>
		<!--<li data-selector="nav li"><a class="serch" data-selector="nav a" href="#search"><img src="{{ asset('sximo/images/Serch-2.png')}}"></a></li>
		
		<li class="dropdown custom-d"> <a href="#" class="dropdown-toggle" data-toggle="dropdown">search</a> 
			<ul class="dropdown-menu custom-serch" style="padding:12px;"> 
				<form class="form-inline"> 
					<button type="submit" id="btn-new" class="btn btn-default pull-right">Search</button>
					<input class="form-control pull-left" placeholder="Search" type="text">
				</form>
			</ul>
		</li>-->
  </ul> 
