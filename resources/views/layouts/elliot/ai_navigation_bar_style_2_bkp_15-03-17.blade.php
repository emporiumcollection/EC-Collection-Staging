														...
														<div class="dl-filter">
															<form>
																@foreach($ourmaindesitnation as $maindest)
																	<div class="form-group post-filter-inputs">
																		<label><a href="{{URL::to('search?continent='.$maindest->category_name.'&s='.$maindest->category_name)}}"> {{$maindest->category_name}}</a></label>
																	</div>
																@endforeach			
															</form>
														</div>
														...
														<div class="dl-filter">
															<form>
																@foreach($regionArrdestts as $regiondest)
																	<div class="form-group post-filter-inputs">
																		<label><a href="{{URL::to('search?continent='.$selcontinent.'&region='.$regiondest->category_name.'&s='.$regiondest->category_name)}}"> {{$regiondest->category_name}}</a></label>
																	</div>
																@endforeach			
															</form>
														</div>
														...
														<div class="dl-filter">
															<form>
																@foreach($countryArrdestts as $countrydest)
																	<div class="form-group post-filter-inputs">
																		<label><a href="{{URL::to('search?continent='.$selcontinent.'&region='.$selregion.'&country='.$countrydest->category_name.'&s='.$countrydest->category_name)}}"> {{$countrydest->category_name}}</a></label>
																	</div>
																@endforeach			
															</form>
														</div>
