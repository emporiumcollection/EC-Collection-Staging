                ...
                <div class="modal-body">
                    <div class="form-group">
                        <div class="form-group form-md-line-input form-md-floating-label has-info">
                            ...
                            <select data-placeholder="Select Type" data-custom-field="type"  class="custom-field-types form-control" name="type" >
                    ...
                    <div class="form-group form-md-radios">
                        ...
                        <div class="md-radio-inline">
                            <div class="md-radio">
                                <?php echo html_entity_decode(Form::radio('status', 'yes',true, ['class' => 'field','id'=>'status_active','data-custom-field'=>'status'])); ?>
                                <?php echo html_entity_decode(Form::label('status_active','<span></span><span class="check"></span><span class="box"></span>Active')); ?>
                            </div>
                            <div class="md-radio">
                                <?php echo html_entity_decode(Form::radio('status', 'no',  null, ['class' => 'field','id'=>'status_inactive','data-custom-field'=>'status'])); ?>
                    ...
                    <div class="form-group form-md-radios">
                        ...
                        <div class="md-radio-inline">
                            <div class="md-radio">
                                <?php echo html_entity_decode(Form::radio('list_view', 'yes',true, ['class' => 'field','id'=>'list_view_active','data-custom-field'=>'list_view'])); ?>
                                <?php echo html_entity_decode(Form::label('list_view_active','<span></span><span class="check"></span><span class="box"></span>Active')); ?>
                            </div>
                            <div class="md-radio">
                                <?php echo html_entity_decode(Form::radio('list_view', 'no',  null, ['class' => 'field','id'=>'list_view_inactive','data-custom-field'=>'list_view'])); ?>
                                <?php echo html_entity_decode(Form::label('list_view_inactive','<span></span><span class="check"></span><span class="box"></span>Inactive')); ?>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group form-md-radios">
                        ...
                        <div class="md-radio-inline">
                            <div class="md-radio">
                                <?php echo html_entity_decode(Form::radio('showinform', 'yes',true, ['class' => 'field','id'=>'showinform_active','data-custom-field'=>'show_in_form'])); ?>
                                <?php echo html_entity_decode(Form::label('showinform_active','<span></span><span class="check"></span><span class="box"></span>Active')); ?>
                            </div>
                            <div class="md-radio">
                                <?php echo html_entity_decode(Form::radio('showinform', 'no',  null, ['class' => 'field','id'=>'showinform_inactive','data-custom-field'=>'show_in_form'])); ?>
                                <?php echo html_entity_decode(Form::label('showinform_inactive','<span></span><span class="check"></span><span class="box"></span>Inactive')); ?>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group form-md-radios">
                        ...
                        <div class="md-radio-inline">
                            <div class="md-radio">
                                <?php echo html_entity_decode(Form::radio('searchable', 'yes',true, ['class' => 'field','id'=>'searchable_active','data-custom-field'=>'searchable'])); ?>
                                <?php echo html_entity_decode(Form::label('searchable_active','<span></span><span class="check"></span><span class="box"></span>Active')); ?>
                            </div>
                            <div class="md-radio">
                                <?php echo html_entity_decode(Form::radio('searchable', 'no',  null, ['class' => 'field','id'=>'searchable_inactive','data-custom-field'=>'searchable'])); ?>
                                <?php echo html_entity_decode(Form::label('searchable_inactive','<span></span><span class="check"></span><span class="box"></span>Inactive')); ?>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group form-md-radios">
                        ...
                        <div class="md-radio-inline">
                            <div class="md-radio">
                                <?php echo html_entity_decode(Form::radio('advance_searchable', 'yes',true, ['class' => 'field','id'=>'advance_searchable_active','data-custom-field'=>'advance_searchable'])); ?>
                                <?php echo html_entity_decode(Form::label('advance_searchable_active','<span></span><span class="check"></span><span class="box"></span>Active')); ?>
                            </div>
                            <div class="md-radio">
                                <?php echo html_entity_decode(Form::radio('advance_searchable', 'no',  null, ['class' => 'field','id'=>'advance_searchable_inactive','data-custom-field'=>'advance_searchable'])); ?>
                                <?php echo html_entity_decode(Form::label('advance_searchable_inactive','<span></span><span class="check"></span><span class="box"></span>Inactive')); ?>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group form-md-radios">
                        ...
                        <div class="md-radio-inline">
                            <div class="md-radio">
                                <?php echo html_entity_decode(Form::radio('filter_searchable', 'yes',true, ['class' => 'field','id'=>'filter_searchable_active','data-custom-field'=>'filter_searchable'])); ?>
                                <?php echo html_entity_decode(Form::label('filter_searchable_active','<span></span><span class="check"></span><span class="box"></span>Active')); ?>
                            </div>
                            <div class="md-radio">
                                <?php echo html_entity_decode(Form::radio('filter_searchable', 'no',  null, ['class' => 'field','id'=>'filter_searchable_inactive','data-custom-field'=>'filter_searchable'])); ?>
                                <?php echo html_entity_decode(Form::label('filter_searchable_inactive','<span></span><span class="check"></span><span class="box"></span>Inactive')); ?>
                            </div>
                        </div>
                    </div>
